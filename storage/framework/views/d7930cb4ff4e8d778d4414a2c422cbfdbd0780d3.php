...
} elseif ($_instance->childHasBeenRendered('yBjkPEp')) {
    $componentId = $_instance->getRenderedChildComponentId('yBjkPEp');
    $componentTag = $_instance->getRenderedChildComponentTagName('yBjkPEp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yBjkPEp');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('yBjkPEp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('hOh7OYl')) {
    $componentId = $_instance->getRenderedChildComponentId('hOh7OYl');
    $componentTag = $_instance->getRenderedChildComponentTagName('hOh7OYl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hOh7OYl');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('hOh7OYl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\bricole\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>