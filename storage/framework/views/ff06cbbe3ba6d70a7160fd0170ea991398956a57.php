        ...
        <header class="bg-gray-50 py-8 rounded-b-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_edit_gig')); ?></h1>
...
} elseif ($_instance->childHasBeenRendered('l2894229920-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894229920-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894229920-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894229920-0');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.overview', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2894229920-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif;?>
...
} elseif ($_instance->childHasBeenRendered('l2894229920-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894229920-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894229920-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894229920-1');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.pricing', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2894229920-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif;?>
...
} elseif ($_instance->childHasBeenRendered('l2894229920-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894229920-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894229920-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894229920-2');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.requirements', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2894229920-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif;?>
...
} elseif ($_instance->childHasBeenRendered('l2894229920-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894229920-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894229920-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894229920-3');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.gallery', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2894229920-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif;?>
...
</div><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/gigs/options/edit.blade.php ENDPATH**/?>