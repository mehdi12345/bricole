<div class="bg-transparent">
	<div class="max-w-7xl mx-auto pb-16 px-4 sm:px-6 lg:pb-16 lg:px-8">
		<div class="max-w-3xl mx-auto text-center">
			<h2 class="text-3xl font-extrabold text-gray-900"><?php echo e(__('messages.t_become_a_seller')); ?></h2>
			<p class="mt-4 text-lg text-gray-500"><?php echo e(__('messages.t_become_a_seller_subtitle')); ?></p>
		</div>
		<dl class="mt-24 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">

            <?php $__currentLoopData = $features;
    ...
    $loop = $__env->getLastLoop();?>
	                <div class="relative">
	                    <dt>
	                        ...
	                        <p class="ltr:ml-9 rtl:mr-9 text-lg leading-6 font-medium text-gray-900"><?php echo e($feature['title']); ?></p>
	                    </dt>
	                    <dd class="mt-2 ltr:ml-9 rtl:mr-9 text-base text-gray-500"><?php echo e($feature['description']); ?></dd>
	                </div>
	            <?php endforeach;
$__env->popLoop();
$loop = $__env->getLastLoop();?>
        ...
        <div class="max-w-xs justify-center flex items-center mx-auto mt-16">
            <button
                ...
                <div wire:loading.remove wire:target="start">
                    <?php echo e(__('messages.t_get_started_now')); ?>
...
</div><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/become/seller.blade.php ENDPATH**/?>