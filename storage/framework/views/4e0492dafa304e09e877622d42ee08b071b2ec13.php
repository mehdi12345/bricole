...
$loop = $__env->getLastLoop();?>
        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_deliver_completed_work')); ?></h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                    ...
                    <span class="hidden sm:block ltr:mr-3 rtl:ml-4">
                        <a href="<?php echo e(url('seller/orders/details', $order->uid)); ?>" type="button" class="inline-flex items-center px-4 py-2 border border-purple-500 rounded-sm shadow-sm text-[13px] font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-50 focus:ring-purple-700">
        ...
        <div class="bg-white rounded-b-md">
            <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 divide-x rtl:divide-x-reverse">
                ...
                <div class="col-span-12 lg:col-span-6">
                    ...
                    <div class="w-full p-6 mb-10">
                        <h3 class="text-base leading-6 font-bold text-gray-900">
                            <?php echo e(__('messages.t_deliver_completed_work')); ?>
                    ...
                    <?php if ($order->delivered_work): ?>
                        ...
                        <?php if ($order->delivered_work->attached_work): ?>
                            ...
                            <div class="py-4 flex items-center justify-between space-x-3 rtl:space-x-reverse lg:ltr:pl-6 lg:rtl:pr-6 mb-10 px-4">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="<?php echo e(url('uploads/delivered/' . $order->order->uid . '/' . $order->uid . '/' . $order->delivered_work->id . '/' . $order->delivered_work->attached_work['id'])); ?>" target="_blank" class="inline-flex items-center py-2 px-4 border border-transparent rounded-full bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-0">
                        ...
                        <?php if ($order->delivered_work->quick_response): ?>
                            ...
                            <div class="flex flex-col space-y-4 overflow-y-auto ltr:pl-6 rtl:pr-6 mb-6">
                                <div class="flex items-center">
                                    ...
                                    <div><span class="px-4 py-2 rounded-lg italic inline-block bg-gray-100 text-gray-900 w-full"><?php echo nl2br($order->delivered_work->quick_response); ?></span></div>
                                    </div>
                                    <img src="<?php echo e(src(auth()->user()->avatar)); ?>" alt="<?php echo e(auth()->user()->username); ?>" class="w-10 h-10 rounded-full order-1 object-cover">
                                </div>
                            </div>
                        ...
                        <?php if (!$order->is_finished): ?>
                            <div class="lg:ltr:pl-6 lg:rtl:pr-6 px-4 mt-12 mb-4">
                                <button x-on:click="confirm('<?php echo e(__("messages.t_are_u_sure_u_want_to_resubmit_work_again")); ?>') ? $wire.resubmit() : ''" type="button" class="text-white w-full bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-0 font-medium rounded-md text-sm px-5 py-4 text-center inline-flex items-center justify-center" wire:loading.attr="disabled" wire:target="resubmit">
                        ...
                        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 px-6">
                            ...
                            <div class="col-span-12">
                                <label class="block text-sm font-medium text-gray-900">
                                    <?php echo e(__('messages.t_upload_work')); ?>

                                </label>
                                <div class="mt-2 relative">
                                    <input x-on:change="fileInputChanged" type="file" accept="application/zip" class="block w-full text-xs text-gray-700 font-medium bg-gray-100 rounded-md cursor-pointer focus:ring-0 focus:outline-none" />
                                </div>
                            ...
                            <div class="col-span-12">
                                <label for="deliver-work-quick-response" class="block text-sm font-medium text-gray-900">
                                    <?php echo e(__('messages.t_quick_response')); ?>

                                </label>
                                <div class="mt-2 relative">
                                    <textarea placeholder="<?php echo e(__('messages.t_describe_ur_delivery_in_detail')); ?>" wire:model.defer="quick_response" rows="8" id="deliver-work-quick-response" class="block w-full text-xs rounded border-2 ltr:pr-10 ltr:pl-3 rtl:pl-10 rtl:pr-3 py-3 font-normal resize-none border-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500" maxlength="2500"></textarea>
...
<?php endif;?>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="flex flex-col w-full h-full">
                        ...
                        <div class="w-full">
                            <div class="mx-auto">
                                <div class="py-6 md:flex md:items-center md:justify-between lg:border-b lg:border-gray-200">
                                    <div class="flex-1 min-w-0 px-6">
                                        <div class="flex items-center">
                                            <img class="hidden h-10 w-10 rounded-full sm:block object-cover" src="<?php echo e(src($order->order->buyer->avatar)); ?>" alt="<?php echo e($order->order->buyer->username); ?>">
                                            <div>
                                                <div class="flex items-center">
                                                    <h1 class="ltr:ml-3 rtl:mr-3 text-base font-bold leading-7 text-gray-900 sm:leading-9 sm:truncate">
                                    ...
                                    <div class="mt-6 flex space-x-3 rtl:space-x-reverse md:mt-0 md:ltr:mr-4 md:rtl:ml-4 ltr:ml-6 rtl:mr-6">
                                        <a href="<?php echo e(url('profile', $order->order->buyer->username)); ?>" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0">
                        ...
                        <div class="w-full">
                            <ul role="list" class="p-6">
                                ...
                                <?php $__currentLoopData = $order->conversation;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $message): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
                                        ...
                                        <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                            <div class="relative">
                                                <img class="h-10 w-10 rounded-md bg-gray-400 flex items-center justify-center ring-8 ring-white object-cover" src="<?php echo e(src($message->from->avatar)); ?>" alt="<?php echo e($message->from->username); ?>">
                                            </div>
                                            <div class="min-w-0 flex-1">
                                            <div>
                                                <div class="text-sm">
                                                    <a href="<?php echo e(url('profile', $message->from->username)); ?>" target="_blank" class="font-medium text-gray-900"><?php echo e($message->from->username); ?></a>
                                                </div>
...
$loop = $__env->getLastLoop();?>
                        ...
                        <?php if (!$order->is_finished): ?>
                            <div class="mt-auto w-full px-6 py-10 border-t bg-gray-50 rounded-br-md">
                                <div class="flex items-start space-x-4 rtl:space-x-reverse">
                                    <div class="flex-shrink-0">
                                        <img class="inline-block h-10 w-10 rounded-full object-cover" src="<?php echo e(src(auth()->user()->avatar)); ?>" alt="<?php echo e(auth()->user()->username); ?>">
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <div class="relative">
                                            <div class="border border-gray-300 rounded-lg shadow-sm overflow-hidden focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
                                                <textarea rows="3" maxlength="750" wire:model.defer="message" class="block w-full py-3 border-0 resize-none focus:ring-0 sm:text-sm" placeholder="<?php echo e(__('messages.t_type_ur_message_here')); ?>"></textarea>
        ...
        function TBhqVNUmCYEnOEj() {
            return {
                ...
                fileInputChanged(e) {
                    ...
                    const max_size  = Number('<?php echo e(settings("media")->delivered_work_max_size); ?>');
                    ...
                    window.livewire.find('<?php echo e($_instance->id); ?>').upload('work', e.target.files[0], (uploadedFilename) => {
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/orders/options/deliver.blade.php ENDPATH**/?>