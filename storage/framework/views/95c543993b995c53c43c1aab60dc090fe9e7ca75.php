...
<?php endif;?>
							...
							<div class="col-span-6 flex items-center">
								<div class="relative flex items-start">
									...
									<div class="ltr:ml-3 rtl:mr-3 text-sm">
									  <label for="remember_me" class="font-medium text-gray-700 cursor-pointer"><?php echo e(__('messages.t_remember_me')); ?></label>
									</div>
								</div>
							</div>
							...
							<div class="col-span-6 ltr:text-right rtl:text-left">
								<a href="<?php echo e(url('auth/password/reset')); ?>" class="font-medium text-gray-700 text-sm"><?php echo e(__('messages.t_forgot_password')); ?></a>
							</div>
...
<?php endif;?>
				...
				<div class="px-4 py-6 bg-gray-50 border-t-2 border-gray-200 sm:px-10 text-center">
					<p class="text-xs leading-5 text-gray-500">
						<?php echo __('messages.t_didnt_receive_confirm_email_resend_it', ['url' => url('auth/request')]); ?>
			...
			<div>
				...
				<div class="text-center md:rtl:text-right md:ltr:text-left w-full min-h-[150px]" wire:ignore>
					...
					<h1 id="auth-text-1" class="text-3xl tracking-wide font-extrabold pb-0 mb-6 text-black leading-10 lg:text-4xl xl:text-5xl">
						<?php echo __('messages.t_register_slide_text_1', ['app_name' => config('app.name')]); ?>
					...
					<h1 id="auth-text-2" class="text-3xl tracking-wide font-extrabold pb-0 mb-6 text-black leading-10 lg:text-4xl xl:text-5xl hidden">
						<?php echo __('messages.t_register_slide_text_2'); ?>
				...
				<a href="<?php echo e(url('auth/register')); ?>" class="mt-10 block text-center w-full rounded-md border border-transparent px-5 py-3 bg-indigo-600 text-base font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:px-10"><?php echo e(__('messages.t_signup')); ?></a>
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/auth/login.blade.php ENDPATH**/?>