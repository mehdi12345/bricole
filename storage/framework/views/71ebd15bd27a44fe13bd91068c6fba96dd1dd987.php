        ...
        <header class="bg-gray-50 py-8 rounded-b-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_gig_analytics')); ?></h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                     ...
                     <span class="hidden sm:block ltr:mr-3 rtl:ml-4">
                        <a href="<?php echo e(url('seller/gigs')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-purple-500">
                ...
                <div class="bg-white relative block p-8 overflow-hidden border border-gray-100 rounded-lg mb-6">
                    ...
                    <div class="justify-between sm:flex">
                        <div>
                            ...
                            <p class="text-[11px] font-[400] text-gray-400"><?php echo e(url('service', $gig->slug)); ?></p>
                        </div>

                        <div class="flex-shrink-0 hidden ltr:ml-3 rtl:mr-3 sm:block">
                            <img
                                class="object-cover w-16 h-16 rounded-lg shadow-sm"
                                src="<?php echo e(src($gig->thumbnail)); ?>"
                    ...
                    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                        ...
                        <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                            <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                <div class="ml-4 mt-4">
                                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_devices')); ?></h3>
                                    <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_devices_chart_subtitle')); ?></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-span-7">
                    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                        ...
                        <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                            <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                <div class="ml-4 mt-4">
                                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_visitors_map')); ?></h3>
                                    <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_visitors_map_subtitle')); ?></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-span-12 lg:col-span-7">
                <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                    ...
                    <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_browsers')); ?></h3>
                                <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_browsers_chart_subtitle')); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-5">
                <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                    ...
                    <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_os')); ?></h3>
                                <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_os_chart_subtitle')); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_recent_orders')); ?></h3>
                                <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_recent_orders_subtitle')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="intro-x">
                        <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="<?php echo e($order->order->buyer->username); ?>" src="<?php echo e(src($order->order->buyer->avatar)); ?>">
                            </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_referrers')); ?></h3>
                                <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_referrers_subtitle')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_cities')); ?></h3>
                                <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_most_visits_by_cities')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="intro-x">
                        <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden ring-gray-100 ring-1">
                                <img alt="<?php echo e($city->country_name); ?>" src="<?php echo e(asset('img/flags', strtolower("$city->country_code.svg"))); ?>">
                            </div>
                            <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(url('js/plugins/jvectormap/jquery-jvectormap-2.0.5.min.js')); ?>"></script>
    <script src="<?php echo e(url('js/plugins/jvectormap/jquery-jvectormap-world-mill.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/gigs/options/analytics.blade.php ENDPATH**/ ?>