            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-10 pb-8">
                    <ul role="list" class="list-disc space-y-6 text-[13px] font-medium text-gray-500">
                        <li class="leading-6">
                            bricole is available only on CodeCanyon, if you buy it or download it from another websites it's either a spam or an edited version that may contains malwares. We always recommend you to <a href="<?php echo e($purchase_link); ?>" target="_blank" class="text-indigo-600">buy bricole</a> from CodeCanyon to get regulary updates and fast support.
                        </li>
                        <li class="leading-6">
                        ...
                        <li class="leading-6">
                            We are not responsible for any incorrect, bad or harmful use of bricole
                        </li>
                        <li class="leading-6">
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/installation/start.blade.php ENDPATH**/?>