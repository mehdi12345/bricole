    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
        ...
        <div class="bg-gray-50 px-8 py-4 rounded-t-md">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_pricing')); ?></h3>
                    <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_create_gig_pricing_subtitle')); ?></p>
                </div>
...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $key => $upgrade): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	        <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200" id="scroll-to-upgrade-id-<?php echo e($key); ?>" wire:key="create-gig-pricing-upgrade-id-<?php echo e($key); ?>">


	            <div class="bg-gray-50 px-8 py-4 rounded-t-md">
	                <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
	                    <div class="ml-4 mt-4">
	                        <h3 class="text-sm leading-6 font-bold tracking-wide text-gray-900"><?php echo e(__('messages.t_upgrade_number', ['number' => $key + 1])); ?></h3>
	                        <p class="text-xs font-normal text-gray-400"><?php echo e($upgrade['title']); ?></p>
	                    </div>
	                    <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
...
<?php endif;?>
                ...
                <div class="col-span-12 md:col-span-6" wire:key="<?php echo e(uid()); ?>">
                    <div class="relative <?php echo e($errors->first('upgrades.' . $key . '.extra_days') ? 'select2-custom-has-error' : ''); ?>">
                        <label class="text-xs font-medium block mb-2 <?php echo e($errors->first('upgrades.' . $key . '.extra_days') ? 'text-red-600 dark:text-red-500' : 'text-gray-700'); ?>"><?php echo e(__('messages.t_delivery_time')); ?></label>
                        <select x-data="initSelect2DeliveryTime('select2-id-upgrades-<?php echo e($key); ?>-extra_days', <?php echo e($key); ?>)" data-pharaonic="select2" data-component-id="<?php echo e($this->id); ?>" wire:model.defer="upgrades.<?php echo e($key); ?>.extra_days" id="select2-id-upgrades-<?php echo e($key); ?>-extra_days" data-placeholder="<?php echo e(__('messages.t_choose_delivery_time')); ?>" data-search-off class="select2_pricing" x-on:change="changed">
                            <option value=""></option>
            ...
            <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                ...
                <div class="col-span-12" wire:key="<?php echo e(uid()); ?>">
                    <div class="flex-grow relative">
                        <span class="absolute top-2/4 left-3 -translate-y-1/2 z-10 text-xs font-normal <?php echo e($errors->first('add_upgrade.title') ? 'text-red-600' : 'text-black'); ?>"><?php echo e(__('messages.t_i_will')); ?></span>
                        <div class="w-full inline-block relative">
                            <div class="relative">
                                <input wire:model.defer="add_upgrade.title" class="indent-6 block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal <?php echo e($errors->first('add_upgrade.title') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500'); ?>" type="text" placeholder="<?php echo e(__('messages.t_describe_ur_offering')); ?>">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <i class="mdi mdi-format-title <?php echo e($errors->first('add_upgrade.title') ? 'text-red-400' : 'text-gray-400'); ?>"></i>
                                </div>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag);?>
                ...
                <div class="col-span-12" wire:key="<?php echo e(uid()); ?>">
                    <div class="relative <?php echo e($errors->first('add_upgrade.extra_days') ? 'select2-custom-has-error' : ''); ?>">

                        <select data-pharaonic="select2" data-component-id="<?php echo e($this->id); ?>" wire:model.defer="add_upgrade.extra_days" id="select2-id-add_upgrade.extra_days" data-placeholder="<?php echo e(__('messages.t_and_an_additional_days')); ?>" data-search-off class="select2_pricing">
                            <option value=""></option>
                            <?php $__currentLoopData = $available_deliveries;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $key => $option): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/create/steps/pricing.blade.php ENDPATH**/?>