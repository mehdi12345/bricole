...
$loop = $__env->getLastLoop();?>
        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_earnings')); ?></h1>
        ...
        <main class="pb-12">
            ...
            <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-12 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 px-10">
                ...
                <p class="text-center bg-gray-50 rounded-lg px-4 py-6">
                  <span class="block text-2xl font-bold text-gray-600"><?php echo money(auth()->user()->balance_net, settings('currency')->code, true); ?></span>
                ...
                <p class="text-center bg-gray-50 rounded-lg px-4 py-6">
                    <span class="block text-2xl font-bold text-gray-600"><?php echo money(auth()->user()->balance_withdrawn, settings('currency')->code, true); ?></span>
                    <span class="mt-2 grid text-base">
                        <span class="font-medium text-gray-600">
                ...
                <p class="text-center bg-gray-50 rounded-lg px-4 py-6">
                    <span class="block text-2xl font-bold text-gray-600"><?php echo money(auth()->user()->balance_purchases, settings('currency')->code, true); ?></span>
                    <span class="mt-2 grid text-base">
                        <span class="font-medium text-gray-600">
                ...
                <p class="text-center bg-gray-50 rounded-lg px-4 py-6">
                    <span class="block text-2xl font-bold text-gray-600"><?php echo money(auth()->user()->balance_pending, settings('currency')->code, true); ?></span>
                    <span class="mt-2 grid text-base">
                        <span class="font-medium text-gray-600">
                ...
                <p class="text-center bg-gray-50 rounded-lg px-4 py-6">
                    <span class="block text-2xl font-bold text-gray-600"><?php echo money(auth()->user()->balance_available, settings('currency')->code, true); ?></span>
                    <span class="mt-2 grid text-base">
                        <span class="font-medium text-gray-600">
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/earnings/earnings.blade.php ENDPATH**/?>