<div class="w-full" x-data="window.lMgwOjCpqGgzsVV" x-init="initialize">
    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
        ...
        <div class="bg-gray-50 px-8 py-4 <?php echo e(count($requirements) === 0 ? 'rounded-md' : 'rounded-t-md'); ?>">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_requirements')); ?></h3>
                <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_create_gig_requirements_subtitle')); ?></p>
                </div>
    ...
    $loop = $__env->getLastLoop();?>
	                        <li wire:key="create-gig-requirement-item-<?php echo e($key); ?>">
	                            <div class="relative <?php echo e(!$loop->last ? 'pb-12' : ''); ?>">
	                                <?php if (!$loop->last): ?>
	                                    <span class="absolute top-4 left-6 -ml-px h-full w-0.5 bg-gray-200" aria-hidden="true"></span>
	                                <?php endif;?>
...
unset($__errorArgs, $__bag);?>
                ...
                <div class="col-span-12">
                    <div class="relative <?php echo e($errors->first('add_requirement.type') ? 'select2-custom-has-error' : ''); ?>">
...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $i => $option): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	                        <div class="col-span-12" wire:key="add-requirement-choice-option-id-<?php echo e($i); ?>">
	                            <div class="flex-grow relative">
	                                <input wire:model.defer="add_requirement.options.<?php echo e($i); ?>" class="block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal <?php echo e($errors->first('add_requirement.options.' . $i) ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500'); ?>" type="text" placeholder="<?php echo e(__('messages.t_add_option')); ?>" maxlength="100">
	                                <?php if (count($add_requirement['options']) > 2): ?>
	                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" wire:click="deleteOption(<?php echo e($i); ?>)">
...
$loop = $__env->getLastLoop();?>
                    ...
                    <div class="col-span-6">
                        <button wire:click="addOption" type="button" class="text-indigo-500 hover:text-white hover:bg-indigo-500 border-2 border-indigo-500 focus:ring-0 focus:outline-none font-medium rounded text-xs px-5 py-2 text-center inline-flex items-center">
         ...
         <?php $__env->slot('footer', null, []);?>
            <div class="flex justify-between w-full">
                ...
                <div class="flex items-center">
                    <input checked id="add-requirement-is-required-checkbox" type="checkbox" value="" class="w-5 h-5 text-indigo-500 bg-transparent border-2 rounded border-gray-400 focus:outline-none focus:ring-0" wire:model.defer="add_requirement.is_required">
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/create/steps/requirements.blade.php ENDPATH**/?>