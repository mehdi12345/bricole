...
} elseif ($_instance->childHasBeenRendered('l3150692618-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3150692618-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3150692618-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3150692618-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l3150692618-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3150692618-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3150692618-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3150692618-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3150692618-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l3150692618-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
