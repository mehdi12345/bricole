...
} elseif ($_instance->childHasBeenRendered('NaDffoT')) {
    $componentId = $_instance->getRenderedChildComponentId('NaDffoT');
    $componentTag = $_instance->getRenderedChildComponentTagName('NaDffoT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NaDffoT');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('NaDffoT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    ...
                    <?php else: ?>
                        <div class="relative overflow-hidden h-[600px]">
                            ...
                            <div style="background-image: asset('home/4.jpg');" class="absolute inset-x-0 bottom-0 top-0  bg-opacity-80 p-6 backdrop-filter backdrop-blur sm:flex sm:items-center sm:justify-between lg:inset-y-0 lg:inset-x-auto lg:w-full lg:flex-col lg:items-center">
...
} elseif ($_instance->childHasBeenRendered('u1t3kTn')) {
    $componentId = $_instance->getRenderedChildComponentId('u1t3kTn');
    $componentTag = $_instance->getRenderedChildComponentTagName('u1t3kTn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('u1t3kTn');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('u1t3kTn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>