            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-6 pb-8">
                    ...
                    <p class="mb-6 text-[13px] font-medium tracking-wider leading-7 text-gray-500">
                        In order for bricole to completely work, we have to run some tasks in the background, Please make sure that your server supports Crontab or contact your server provider to check if they support it.<br>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/installation/crontab.blade.php ENDPATH**/?>