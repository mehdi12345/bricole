...
} elseif ($_instance->childHasBeenRendered('l1380052812-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1380052812-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1380052812-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1380052812-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l1380052812-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <?php endif;?>
                          ...
                          style="display: none;">
                            <ul class="relative z-0 divide-y divide-gray-200 border-b border-gray-200 w-[230px] sm:w-[375px] md:w-[400px] lg:min-w-[480px] max-h-80 overflow-y-auto" role="list">
                                ...
                                <?php $__empty_1 = true;
$__currentLoopData = $notifications;
...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $seller): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
				                                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
				                                    ...
				                                    <li class="first:rounded-t-md last:rounded-b-md">
				                                        ...
				                                        <div id="category-subcategories-drop-down-<?php echo e($category->uid); ?>" class="hidden z-10 w-64 bg-white rounded-md shadow-md shadow-gray-200" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="right-start" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(10.4px, 456.8px, 0px);">
				                                            <ul class="text-sm text-gray-700">
				                                                ...
				                                                <?php $__currentLoopData = $category->subcategories;
    $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $subcategory): $__env->incrementLoopIndices();
        $loop = $__env->getLastLoop();?>
								                                                    <li>
...
} elseif ($_instance->childHasBeenRendered('l1380052812-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1380052812-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1380052812-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1380052812-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l1380052812-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush();?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/includes/header.blade.php ENDPATH**/?>