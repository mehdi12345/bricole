...
<?php endif;?>
                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_verification_center')); ?></h2>
                            <p class="mt-1 text-sm text-gray-500"><?php echo e(__('messages.t_verification_center_subtitle')); ?></p>
                        </div>
                                    ...
                                    <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                        ...
                                        <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                            ...
                                            <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                <a href="<?php echo e(url('uploads/verifications/' . $verification->uid . '/selfie/' . $verification->file_selfie)); ?>" target="_blank" class="font-medium text-indigo-500 hover:text-indigo-600 text-xs"> <?php echo e(__('messages.t_download')); ?> </a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                            ...
                                            <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                <a href="<?php echo e(url('uploads/verifications/' . $verification->uid . '/front/' . $verification->file_front_side)); ?>" target="_blank" class="font-medium text-indigo-500 hover:text-indigo-600 text-xs"> <?php echo e(__('messages.t_download')); ?> </a>
                                            </div>
                                        </li>
                                        ...
                                        <?php if ($verification->document_type !== 'passport'): ?>
                                            <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                    <a href="<?php echo e(url('uploads/verifications/' . $verification->uid . '/back/' . $verification->file_back_side)); ?>" target="_blank" class="font-medium text-indigo-500 hover:text-indigo-600 text-xs"> <?php echo e(__('messages.t_download')); ?> </a>
                                                </div>
                                            </li>
                                        <?php endif;?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if ($currentStep === 1): ?>
                                ...
                                <fieldset>
                                    <legend class="text-xs font-medium text-gray-900 mb-2"><?php echo e(__('messages.t_choose_document_type')); ?></legend>
    ...
    <script>
        function nYpPIEgUauhEVLt() {
            return {
                ...
                snapshot() {
                    if (this.counter > 5) {
                        window.toast("<?php echo e(__('messages.t_unable_to_take_more_selfies')); ?>", 'warning');
                        return;
                    }
                    const _this = this;
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/account/verification/verification.blade.php ENDPATH**/?>