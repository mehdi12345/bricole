...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $r): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="refunds-<?php echo e($r->id); ?>">


	                        <td class="ltr:pl-4 rtl:pr-4">
	                            <a href="<?php echo e(url('service', $r->item->gig->slug)); ?>" target="_blank" class="flex items-center">
	                                <div class="w-8 h-8">
	                                    <img class="w-full h-full rounded object-cover" src="<?php echo e(src($r->item->gig->thumbnail)); ?>" alt="<?php echo e($r->item->gig->title); ?>" />
	                                </div>
	                        ...
	                        <td class="ltr:pl-4 rtl:pr-4">
	                            <a href="<?php echo e(url('profile', $r->seller->username)); ?>" target="_blank" class="flex items-center">
	                                <div class="w-8 h-8">
	                                    <img class="w-full h-full rounded object-cover" src="<?php echo e(src($r->seller->avatar)); ?>" alt="<?php echo e($r->seller->username); ?>" />
	                                </div>
	                                <div class="ltr:pl-4 rtl:pr-4">
	                        ...
	                        <td class="ltr:pl-4 rtl:pr-4">
	                            <a href="<?php echo e(url('profile', $r->buyer->username)); ?>" target="_blank" class="flex items-center">
	                                <div class="w-8 h-8">
	                                    <img class="w-full h-full rounded object-cover" src="<?php echo e(src($r->buyer->avatar)); ?>" alt="<?php echo e($r->buyer->username); ?>" />
	                                </div>
	                                <div class="ltr:pl-4 rtl:pr-4">
    ...
    case ('pending'): ?>
	                        ...
	                        <td class="text-center">
	                            <span class="text-[11px] font-normal text-gray-400"><?php echo e(format_date($r->created_at, 'ago')); ?></span>
	                        </td>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/refunds/refunds.blade.php ENDPATH**/?>