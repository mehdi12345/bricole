...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $order): $__env->incrementLoopIndices();
    ...
    $__empty_1 = false;?>
	                                ...
	                                <div class="bg-white border border-gray-200 rounded-md mb-10" wire:key="orders-<?php echo e($order->uid); ?>">
	                                    <div class="bg-gray-50 border-b sm:rounded-t-md flex items-center p-4  sm:p-6 sm:grid sm:grid-cols-4 sm:gap-x-6">
	                                        ...
	                                        <dl class="flex-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
	                                            ...
	                                            <div>
	                                                <dt class="font-medium text-gray-900"><?php echo e(__('messages.t_date_placed')); ?></dt>
	                                                <dd class="mt-2 text-gray-500 text-xs"><?php echo e(format_date($order->placed_at, 'F j, Y h:i A')); ?></dd>
	                                            </div>


	                                            <div>
	                                                <dt class="font-medium text-gray-900"><?php echo e(__('messages.t_total_amount')); ?></dt>
	                                                <dd class="mt-1 font-medium text-gray-900"><?php echo money($order->total_value, settings('currency')->code, true); ?></dd>
	                                            </div>
		                                                        ...
		                                                        <div class="md:flex md:items-center md:justify-between md:space-x-4 rtl:space-x-reverse xl:pb-4">
                                                                    ...
                                                                    <span class="flex">
                                                                        <div class="md:text-center">
                                                                            ...
                                                                            <?php elseif ($item->order->invoice->status === 'pending'): ?>
...
case ('pending'): ?>
                                                            ...
                                                            <div class="mt-4 flex space-x-3 md:mt-0">
                                                                ...
                                                                <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-actions-dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-48 dark:bg-gray-700">
                                                                    <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">


                                                                        <li>
                                                                            <a href="<?php echo e(url('messages/new', $item->owner?->username)); ?>" target="_blank" class="flex items-center px-4 py-2 hover:bg-gray-100 rounded-t">
                                                                                <i class="mdi mdi-email-fast text-[20px] ltr:mr-3 rtl:ml-3 text-gray-500"></i>
                                                                                <span class="text-xs font-medium text-gray-700"><?php echo e(__('messages.t_contact_seller')); ?></span>
                                                                            </a>
                                                                        </li>
    ...
    ?>
                                                                        ...
                                                                        <?php if ($item->refund): ?>
                                                                            ...
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/refunds/details', $item->refund->uid)); ?>" target="_blank" class="flex items-center px-4 py-2 hover:bg-gray-100">
                                                                                    <i class="mdi mdi-cash-refund text-[20px] ltr:mr-3 rtl:ml-3 text-gray-500"></i>
                                                                                    <span class="text-xs font-medium text-gray-700"><?php echo e(__('messages.t_refund_details')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <?php if ($can_refund): ?>
                                                                                <li>
                                                                                    <a href="<?php echo e(url('account/refunds/request', $item->uid)); ?>" target="_blank" class="flex items-center px-4 py-2 hover:bg-gray-100">
                                                                                        <i class="mdi mdi-cash-refund text-[20px] ltr:mr-3 rtl:ml-3 text-gray-500"></i>
                                                                                        <span class="text-xs font-medium text-gray-700"><?php echo e(__('messages.t_request_refund')); ?></span>
                                                                                    </a>
                                                                                </li>
                                                                            <?php endif;?>
                                                                        ...
                                                                        <?php if (in_array($item->status, ['proceeded', 'delivered'])): ?>
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/orders/files?orderId=' . $order->uid . '&itemId=' . $item->uid)); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100">
                                                                                    <i class="mdi mdi-tray-arrow-down text-[20px] ltr:mr-3 rtl:ml-3 text-gray-500"></i>
                                                                                    <span class="text-xs font-medium text-gray-700"><?php echo e(__('messages.t_delivered_work')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        <?php endif;?>


                                                                        <?php if ($item->status === 'pending' && $item->order->invoice->status === 'paid'): ?>
                                                                            <li>
                                                                                <button type="button" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_cancel_service')); ?>') ? $wire.cancel('<?php echo e($item->uid); ?>') : ''" wire:loading.attr="disabled" wire:target="cancel('<?php echo e($item->uid); ?>')" class="flex items-center px-4 py-2 hover:bg-gray-100 w-full">
                                                                        ...
                                                                        <?php if (($item->status === 'pending' || $item->status === 'proceeded') && $item->order->invoice->status === 'paid'): ?>
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid)); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100 rounded-b">
                                                                                    <i class="mdi mdi-send text-[20px] ltr:mr-3 rtl:ml-3 text-gray-500"></i>
                                                                                    <span class="text-xs font-medium text-gray-700"><?php echo e(__('messages.t_send_requirements')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        <?php endif;?>
                                                                        ...
                                                                        <?php if ($item->status === 'delivered' && $item->is_finished): ?>
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/reviews/create/' . $item->uid)); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100 rounded-b">
                                                                                    <i class="mdi mdi-star text-[20px] ltr:mr-3 rtl:ml-3 text-gray-500"></i>
                                                                                    <span class="text-xs font-medium text-gray-700"><?php echo e(__('messages.t_make_a_review')); ?></span>
                                                                                </a>
                                                                            </li>
                                                                        <?php endif;?>
    ...
    $loop = $__env->getLastLoop();?>
                                                ...
                                                <div class="mt-6 sm:flex sm:justify-between">
                                                    ...
                                                    <?php if ($item->order->invoice->status === 'paid' && $item->status === 'pending'): ?>
                                                    ...
                                                    <div class="mt-6 border-t border-gray-200 pt-4 flex items-center space-x-4 divide-x divide-gray-200 rtl:divide-x-reverse text-sm font-medium sm:mt-0 sm:ltr:ml-4 sm:rtl:mr-4 sm:border-none sm:pt-0 rtl:space-x-reverse">
                                                        ...
                                                        <div class="flex-1 flex justify-center">
                                                            <a href="<?php echo e(url('service', $item->gig->slug)); ?>" target="_blank" class="text-indigo-600 whitespace-nowrap hover:text-indigo-500"><?php echo e(__('messages.t_view_gig')); ?></a>
                                                        </div>


                                                        <?php if (($item->status === 'pending' || $item->status === 'proceeded') && $item->order->invoice->status === 'paid'): ?>
                                                            <div class="flex-1 ltr:pl-4 rtl:pr-4 flex justify-center">
                                                                <a href="<?php echo e(url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid)); ?>" class="text-indigo-600 whitespace-nowrap hover:text-indigo-500"><?php echo e(__('messages.t_send_requirements')); ?></a>
                                                            </div>
                                                        <?php endif;?>
...
</main><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/account/orders/orders.blade.php ENDPATH**/?>