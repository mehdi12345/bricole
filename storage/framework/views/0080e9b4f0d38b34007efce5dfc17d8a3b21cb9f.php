        ...
        <table class="w-full whitespace-nowrap">
            <thead class="bg-gray-200">
                <tr tabindex="0"
                    ...
                    <th class="font-bold text-[10px] text-slate-500 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4">
                        <?php echo e(__('messages.t_paypal_email')); ?></th>
	                    ...
	                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100"
	                        ...
	                        <td class="ltr:pl-4 rtl:pr-4">
	                            <a href="<?php echo e(url('profile', $w->user->username)); ?>" target="_blank"
	                                ...
	                                <div class="w-8 h-8">
	                                    <img class="w-full h-full rounded object-cover" src="<?php echo e(src($w->user->avatar)); ?>"
	                        ...
	                        <td class="text-center">
	                            <span class="text-xs font-black font-[Lato]"><?php echo money($w->amount, settings('currency')->code, true); ?></span>
	                        </td>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/withdrawals/withdrawals.blade.php ENDPATH**/?>