    ...
    >
        ...
        >
            <div class="py-2">
                ...
                <?php $__empty_1 = true;
$__currentLoopData = $levelsFound;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $levelCount): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();
    $__empty_1 = false;?>
	                <button wire:click="toggleLevel('<?php echo e($levelCount->level->value); ?>')">
	                    <?php if (isset($component)) {$__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component;}?>
	<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'log-viewer::components.checkmark', 'data' => ['class' => 'checkmark mr-2.5', 'checked' => $levelCount->selected]] + (isset($attributes) ? (array) $attributes->getIterator() : []));?>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\vendor\opcodesio\log-viewer\src/../resources/views/partials/log-list-level-buttons.blade.php ENDPATH**/?>