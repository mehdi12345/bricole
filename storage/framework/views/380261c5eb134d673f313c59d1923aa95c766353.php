<div class="container mx-auto" x-data="window.xXYTvEuUwBxUJgG">
    ...
    <?php if (session()->has('success')): ?>
        <div class="rounded-md bg-green-100 p-4 mb-6">
            <div class="flex">
                ...
                <div class="ltr:ml-3 rtl:mr-3">
                    <h3 class="text-sm font-medium text-green-800"><?php echo e(__('messages.t_congratulations')); ?></h3>
        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_withdrawals')); ?></h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                    ...
                    <span class="hidden sm:block ltr:ml-3 rtl:pr-3">
                    ...
                    <span class="hidden sm:block ltr:ml-3 rtl:pr-3">
                        <a href="<?php echo e(url('seller/withdrawals/settings')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-purple-500">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-10 py-3 ltr:text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    ...
                                    <th scope="col" class="px-10 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <?php $__currentLoopData = $withdrawals;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $w): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	                                    <tr>


	                                        <td class="px-10 py-6 whitespace-nowrap text-sm font-medium text-gray-900">
	                                            <?php echo e(format_date($w->created_at, 'F j, Y')); ?>

	                                        </td>


	                                        <td class="px-10 py-4 whitespace-nowrap text-sm text-gray-500 flex items-center">
                                        ...
                                        <td class="px-10 py-6 whitespace-nowrap text-sm text-gray-900 font-black text-center">
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/withdrawals/withdrawals.blade.php ENDPATH**/?>