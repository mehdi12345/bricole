        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_review_details')); ?></h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                    ...
                    <span class="hidden sm:block ltr:mr-3 rtl:ml-4">
                        <a href="<?php echo e(url('messages/new', $review->user->username)); ?>" target="_blank" class="inline-flex items-center px-4 py-2 border border-purple-500 rounded-sm shadow-sm text-[13px] font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-50 focus:ring-purple-700">
            ...
            <article class="md:gap-8 md:grid md:grid-cols-3 px-6 py-8">
                <div>
                    <div class="flex items-center mb-6 space-x-4 rtl:space-x-reverse">
                        <img class="w-10 h-10 rounded-full object-cover" src="<?php echo e(src($review->user->avatar)); ?>" alt="<?php echo e($review->user->username); ?>">
                        <div class="space-y-1 font-medium dark:text-white">
                            <p><?php echo e($review->user->username); ?></p>
                            <?php if($review->user->country): ?>
                                <div class="flex items-center text-xs text-gray-500 dark:text-gray-400">
                                    <img src="<?php echo e(asset('img/flags/' . strtolower($review->user->country->code) . '.svg')); ?>" alt="<?php echo e($review->user->country->name); ?>" class="h-3.5 ltr:mr-2 rtl:ml-2">
                    ...
                    <ul class="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <li class="flex items-center">
                            ...
                            <?php echo e(__('messages.t_signed_up_on_date', ['date' => format_date($review->user->created_at, 'F j, Y')])); ?>
...
</div><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/reviews/options/details.blade.php ENDPATH**/ ?>