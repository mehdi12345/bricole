...
} elseif ($_instance->childHasBeenRendered('l4040918207-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4040918207-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4040918207-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4040918207-0');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.overview', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l4040918207-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l4040918207-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4040918207-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4040918207-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4040918207-1');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.pricing', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l4040918207-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
        ...
        <?php if($step === 'gallery' || $step === 'requirements'): ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('main.seller.gigs.options.steps.gallery', ['gig' => $gig])->html();
} elseif ($_instance->childHasBeenRendered('l4040918207-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4040918207-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4040918207-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4040918207-2');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.gallery', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l4040918207-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/gigs/options/edit.blade.php ENDPATH**/ ?>