                                    ...
                                    <div class="bg-gray-50 border-b sm:rounded-t-md flex items-center p-4  sm:p-6 sm:grid sm:grid-cols-4 sm:gap-x-6">
                                        ...
                                        <dl class="flex-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
                                            ...
                                            <div>
                                                ...
                                                <dd class="mt-1 font-medium text-gray-900"><?php echo e($order->total_value); ?> DH</dd>
                                            </div>
                                                                    ...
                                                                    <span class="flex">
                                                                        <div class="md:text-center">
                                                                            ...
                                                                            <p class="mt-2 text-[11px] text-gray-600 font-medium">
                                                                              <?php echo e($item->total_value); ?> DH
                                                                            </p>
                                                                        </div>
                                                                    </span>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/account/orders/orders.blade.php ENDPATH**/ ?>