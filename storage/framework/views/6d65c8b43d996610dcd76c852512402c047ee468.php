        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_my_gigs')); ?></h1>
                            ...
                            <table class="w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr class="divide-x divide-gray-50">
                                        ...
                                        <th scope="col" class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('messages.t_price')); ?></th>
                                        ...
                                        <th scope="col" class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('messages.t_sales')); ?></th>
                                        <th scope="col" class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('messages.t_clicks')); ?></th>
...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $gig): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();
    $__empty_1 = false;?>
	                                        <tr wire:key="seller-gigs-id-<?php echo e($gig->uid); ?>">
	                                            ...
	                                            <td class="whitespace-nowrap py-4 ltr:pl-10 rtl:pr-10 ltr:pr-3 rtl:pl-3 text-sm font-medium text-gray-900 sm:ltr:pl-10 sm:rtl:pr-10">
	                                                <div class="flex items-center">
	                                                    <div class="h-10 w-10 flex-shrink-0">
	                                                        <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e(src($gig->thumbnail)); ?>" alt="<?php echo e($gig->title); ?>">
	                                                    </div>
	                                                    <div class="ltr:ml-4 rtl:mr-4">
	                                                        <a href="<?php echo e(url('service', $gig->slug)); ?>" target="_blank" class="font-medium text-gray-900 pb-1 hover:text-indigo-600 block"><?php echo e($gig->title); ?></a>
	                                                        <div class="text-gray-500 font-normal">
	                                                            <nav class="flex" aria-label="Breadcrumb">
	                                                                <ol role="list" class="flex items-center space-x-4 rtl:space-x-reverse">
	                                                                    ...
	                                                                    <li>
	                                                                        <div class="flex items-center">
	                                                                            <a href="<?php echo e(url('categories', $gig->category->slug)); ?>" target="_blank" class="text-xs font-normal text-gray-500 hover:text-gray-700"><?php echo e($gig->category->name); ?></a>
	                                                                        </div>
	                                                                    </li>
	                                                                    ...
	                                                                    <li>
	                                                                        <div class="flex items-center">
	                                                                            ...
	                                                                            <a href="<?php echo e(url('categories/' . $gig->category->slug . '/' . $gig->subcategory->slug)); ?>" target="_blank" class="ltr:ml-4 rtl:mr-4 text-xs font-normal text-gray-500 hover:text-gray-700" aria-current="page"><?php echo e($gig->subcategory->name); ?></a>
	                                                                        </div>
	                                                                    </li>
	                                                                </ol>
	                                                            </nav>
	                                            ...
	                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 text-center">
	                                                <div class="text-gray-900 text-sm font-black font-[Lato]"><?php echo money($gig->price, settings('currency')->code, true); ?></div>
	                                                <div class="text-gray-500 text-xs"><?php echo e(__('messages.t_number_days_for_delivery', ['number' => $gig->delivery_time])); ?></div>
	                                            </td>


	                                            <td class="text-center">
	                                                <div class="gig_rating_container mx-auto mb-1 z-0" data-rating-value="<?php echo e($gig->rating); ?>"></div>
	                                            ...
	                                            <td class="text-center font-medium text-sm text-gray-800">
	                                                ...
	                                                <p class="text-xs text-gray-400 tracking-wide font-normal"><?php echo e(__('messages.t_number_orders_in_queue', ['number' => $gig->orders_in_queue])); ?></p>
	                                            </td>
    ...
    case ('pending'): ?>
	                                            ...
	                                            <td class="text-center">
	                                                <div class="relative inline-block text-left">
	                                                    <div class="z-0">
	                                                        <button data-dropdown-toggle="seller-gigs-options-<?php echo e($gig->uid); ?>" data-dropdown-placement="left-start" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0 z-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
	                                                    ...
	                                                    <div id="seller-gigs-options-<?php echo e($gig->uid); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
	                                                        <div class="py-1" role="none">


	                                                            <a href="<?php echo e(url('seller/gigs/edit/' . $gig->uid . '?step=overview')); ?>" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
	                                                            ...
	                                                            <a href="<?php echo e(url('seller/gigs/analytics', $gig->uid)); ?>" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
	                                                        ...
	                                                        <div class="py-1" role="none">
	                                                                <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_gig')); ?>') ? $wire.delete('<?php echo e($gig->uid); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($gig->uid); ?>')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >


	                                                                    <div wire:loading wire:target="delete('<?php echo e($gig->uid); ?>')">
	                                                                    ...
	                                                                    <div wire:loading.remove wire:target="delete('<?php echo e($gig->uid); ?>')">
...
<?php $__env->stopPush();?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/gigs/gigs.blade.php ENDPATH**/?>