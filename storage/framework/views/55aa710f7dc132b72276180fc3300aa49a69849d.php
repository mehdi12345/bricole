                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-y-auto border !border-t-0 !border-b-0">
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody class="w-full">
                                    ...
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="list-<?php echo e($l->id); ?>">
                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="<?php echo e(url('service', $l->gig->slug)); ?>" target="_blank" class="flex items-center">
                                                    ...
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        ...
                                                        <p class="text-[11px] leading-3 text-gray-600 pt-2"><?php echo e($l->gig->price); ?> DH</p>
                                                    </div>
                                                </a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span class="text-[11px] font-normal text-gray-400"><?php echo e($l->status); ?></span>
                                            </td>
                                                ...
                                                <div class="relative inline-block text-left">
                                                    ...
                                                    <div id="table-options-dropdown-<?php echo e($l->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                                        <div class="py-1" role="none">
                                                            ...
                                                            <a href="<?php echo e(url('payment', $l->gig->id)); ?>" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1">
                                                            ...
                                                            <?php endif; ?>
                                                                ...
                                                                <div class="py-1" role="none">
                                                                    <a href="<?php echo e(url('account/orders/requirements',$l->id)); ?>" class="flex items-center px-4 py-2 hover:bg-gray-100 rounded-b">
                                                            ...
                                                            <?php if($l->id_requirment > 0): ?>
                                                                <div class="py-1" role="none">
                                                                    <button x-on:click="confirm('<?php echo e(__('messages.t_requirements')); ?>') ? $wire.dawland('<?php echo e($l->id_requirment); ?>','<?php echo e($l->id); ?>') : ''"   class="flex items-center px-4 py-2 hover:bg-gray-100">
