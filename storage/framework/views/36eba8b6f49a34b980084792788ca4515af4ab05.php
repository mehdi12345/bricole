    ...
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between w-full">
        <div class="flex justify-between flex-1 md:hidden">
            <?php if($paginator->onFirstPage()): ?>
                <span class="relative inline-flex items-center px-4 py-2 text-xs font-medium text-gray-500 bg-white border-2 border-gray-200 cursor-default leading-5 rounded">
                    <?php echo __('messages.t_page_previous'); ?>

                </span>
            <?php else: ?>
                <a href="<?php echo e($paginator->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 ltr:mr-3 rtl:ml-3 text-xs font-medium text-gray-500 bg-white border border-gray-200 shadow-sm leading-5 rounded-sm tracking-wider hover:text-gray-500 focus:outline-none transition ease-in-out duration-150">

                    
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ltr:mr-2 rtl:ml-2 hidden rtl:block text-gray-400" viewBox="0 0 20 20" fill="currentColor"> <path fill-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>

                    
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ltr:ml-2 rtl:mr-2 hidden ltr:block text-gray-400" viewBox="0 0 20 20" fill="currentColor"> <path fill-rule="evenodd" d="M9.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L7.414 9H15a1 1 0 110 2H7.414l2.293 2.293a1 1 0 010 1.414z" clip-rule="evenodd"/></svg>
            ...
            <?php if($paginator->hasMorePages()): ?>
                <a href="<?php echo e($paginator->nextPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 ltr:ml-3 rtl:mr-3 text-xs font-medium text-gray-500 bg-white border border-gray-200 shadow-sm leading-5 rounded-sm tracking-wider hover:text-gray-500 focus:outline-none transition ease-in-out duration-150">
            ...
            <?php else: ?>
                <span class="relative inline-flex items-center px-4 py-2 ml-3 text-xs font-medium text-gray-500 bg-white border-2 border-gray-200 cursor-default leading-5 rounded">
                    <?php echo __('messages.t_page_next'); ?>
                ...
                <span class="relative z-0 flex space-x-1 rtl:space-x-reverse">
                    ...
                    <?php if($paginator->onFirstPage()): ?>
                        <span aria-disabled="true" aria-label="<?php echo e(__('pagination.previous')); ?>">
                            <span class="relative inline-flex items-center justify-center text-xs font-medium w-8 h-8 leading-8 text-center border border-gray-100 rounded-full cursor-not-allowed" aria-hidden="true">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" class="relative inline-flex items-center justify-center text-xs font-medium w-8 h-8 leading-8 text-center border border-gray-100 rounded-full" aria-label="<?php echo e(__('pagination.previous')); ?>">
                            ...
                            <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($page == $paginator->currentPage()): ?>
                                    <span aria-current="page">
                                        <span class="block w-8 h-8 leading-8 text-center text-white bg-indigo-500 border-indigo-500 rounded-full text-xs font-medium"><?php echo e($page); ?></span>
                                    </span>
                                <?php else: ?>
                                    <a href="<?php echo e($url); ?>" class="block w-8 h-8 leading-8 text-center border border-gray-100 rounded-full text-xs font-medium" aria-label="<?php echo e(__('Go to page :page', ['page' => $page])); ?>">
                                        <?php echo e($page); ?>
                    ...
                    <?php if($paginator->hasMorePages()): ?>
                        <a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" class="relative inline-flex items-center justify-center text-xs font-medium w-8 h-8 leading-8 text-center border border-gray-100 rounded-full" aria-label="<?php echo e(__('pagination.next')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>