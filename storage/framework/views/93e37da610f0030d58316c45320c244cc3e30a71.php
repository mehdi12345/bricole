...
<?php endif; ?>
    ...
    <main class="">
        ...
        <div class="flex justify-between items-center mb-2 bg-transparent py-2 ltr:pr-6 rtl:pl-6 ltr:border-l-8 rtl:border-r-8 ltr:pl-4 rtl:pr-4 border-indigo-600 rounded">
            ...
            <div>
                <span class="font-extrabold text-base text-gray-800 pb-1 block tracking-wider"><?php echo e($subcategory->name); ?></span>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/categories/subcategory.blade.php ENDPATH**/ ?>