                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_refunds')); ?></h2>
                            <p class="mt-1 text-sm text-gray-500"><?php echo e(__('messages.t_refunds_subtitle')); ?></p>
                        </div>
                            ...
                            <table class="w-full whitespace-nowrap">
                                <thead class="bg-gray-100">
                                    <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800 dark:text-white">
                                        <th class="font-bold text-[10px] text-slate-500 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_item')); ?></th>
                                        <th class="font-bold text-[10px] text-slate-500 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_seller')); ?></th>
                                ...
                                <tbody class="w-full">
                                    ...
                                    <?php $__currentLoopData = $refunds;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $refund): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	                                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="refunds-<?php echo e($refund->id); ?>">


	                                            <td class="ltr:pl-4 rtl:pr-4">
	                                                <a href="<?php echo e(url('service', $refund->item->gig->slug)); ?>" target="_blank" class="flex items-center">
	                                                    <div class="w-8 h-8">
	                                                        <img class="w-full h-full rounded object-cover" src="<?php echo e(src($refund->item->gig->thumbnail)); ?>" alt="<?php echo e($refund->item->gig->title); ?>" />
	                                                    </div>
	                                                    <div class="ltr:pl-4 rtl:pr-4">
	                                                        <p class="font-medium text-xs truncate max-w-lg block overflow-hidden"><?php echo e($refund->item->gig->title); ?></p>
	                                                        <p class="text-[11px] leading-3 text-gray-600 pt-2"><?php echo money($refund->item->gig->price, settings('currency')->code, true); ?></p>
	                                                    </div>
	                                                </a>
	                                            </td>
	                                            ...
	                                            <td class="ltr:pl-4 rtl:pr-4">
	                                                <a href="<?php echo e(url('profile', $refund->seller->username)); ?>" target="_blank" class="flex items-center">
	                                                    <div class="w-8 h-8">
	                                                        <img class="w-full h-full rounded object-cover" src="<?php echo e(src($refund->seller->avatar)); ?>" alt="<?php echo e($refund->seller->username); ?>" />
	                                                    </div>
	                                                    <div class="ltr:pl-4 rtl:pr-4">
	                                                        <p class="font-medium text-xs truncate max-w-lg block overflow-hidden"><?php echo e($refund->seller->username); ?></p>
...
case ('pending'): ?>
                                            ...
                                            <td class="text-center">
                                                <span class="text-[11px] font-normal text-gray-400"><?php echo e(format_date($refund->created_at, 'ago')); ?></span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div>
                                                        <a href="<?php echo e(url('account/refunds/details', $refund->uid)); ?>" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0" aria-expanded="true" aria-haspopup="true">
...
</main><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/account/refunds/refunds.blade.php ENDPATH**/?>