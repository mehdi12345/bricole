<header class="z-10 relative py-4 bg-white shadow-sm dark:bg-gray-800 h-16">
    <div class="flex items-center justify-between h-full px-6 text-purple-600 dark:text-purple-300">
        ...
        <div class="h-full flex items-center">
            ...
            <a href="<?php echo e(admin_url()); ?>" class="block h-full py-1.5">
                <img src="<?php echo e(src(settings('general')->logo)); ?>" alt="<?php echo e(settings('general')->title); ?>" class="h-full hidden md:block">
            </a>
        </div>
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6 rtl:space-x-reverse">
            ...
            <?php if ($pending_gigs): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('gigs')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-pending-gigs">
                        ...
                        <div id="tooltip-notifications-pending-gigs" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            <?php echo e(__('messages.t_pending_gigs')); ?>
            ...
            <?php if ($pending_verifications): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('verifications')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-pending-verifications">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
                        ...
                        <div id="tooltip-notifications-pending-verifications" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            <?php echo e(__('messages.t_pending_verifications')); ?>
            ...
            <?php if ($pending_withdrawals): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('withdrawals')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-pending-withdrawals">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
                        ...
                        <div id="tooltip-notifications-pending-withdrawals" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            <?php echo e(__('messages.t_pending_withdrawals')); ?>
            ...
            <?php if ($pending_portfolios): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('portfolios')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-pending-portfolios">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
                        ...
                        <div id="tooltip-notifications-pending-portfolios" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            <?php echo e(__('messages.t_pending_portfolios')); ?>
            ...
            <?php if ($pending_users): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('users')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-pending-users">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
                        ...
                        <div id="tooltip-notifications-pending-users" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            <?php echo e(__('messages.t_pending_users')); ?>
            ...
            <?php if ($pending_refunds): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('refunds')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-pending-refunds">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
                        ...
                        <div id="tooltip-notifications-pending-refunds" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            <?php echo e(__('messages.t_pending_refunds')); ?>
            ...
            <?php if ($reported_gigs): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('reports/gigs')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-reported-gigs">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
            ...
            <?php if ($reported_users): ?>
                <li class="flex">
                    <a href="<?php echo e(admin_url('reports/users')); ?>" class="flex items-center justify-center group" data-tooltip-target="tooltip-notifications-reported-users">
                        <span class="relative inline-flex">
                            <div class="h-8 w-8 flex items-center transition ease-in-out duration-150 justify-center rounded-md border-2 border-gray-50 bg-white group-hover:bg-gray-50">
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/includes/header.blade.php ENDPATH**/?>