...
} elseif ($_instance->childHasBeenRendered('l76757622-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l76757622-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l76757622-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l76757622-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l76757622-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l76757622-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l76757622-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l76757622-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l76757622-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l76757622-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\bricole\resources\views/livewire/main/includes/header.blade.php ENDPATH**/ ?>