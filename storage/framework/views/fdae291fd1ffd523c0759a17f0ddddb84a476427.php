	                            ...
	                            <?php if ($page->column == 1): ?>
	                                <li>
	                                    <?php if ($page->is_link && $page->link): ?>
	                                        <a href="<?php echo e($page->link); ?>" target="_blank" class="block font-normal text-gray-400 hover:text-gray-600 hover:underline text-sm mb-2">
	                                            <?php echo e($page->title); ?>

	                                        </a>
	                                    <?php else: ?>
                                        <a href="<?php echo e(url('page', $page->slug)); ?>" class="block font-normal text-gray-400 hover:text-gray-600 hover:underline text-sm mb-2">
                                            <?php echo e($page->title); ?>
...
$loop = $__env->getLastLoop();?>
                ...
                <?php if (settings('footer')->is_language_switcher): ?>
                    <button @click="languages = !languages" class="inline-flex items-center px-2.5 py-2 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mt-10">
                        <img src="<?php echo e(asset('img/flags/rounded/' . strtolower($default_country_code) . '.svg')); ?>" alt="" class="w-4 h-4 ltr:mr-3 rtl:ml-3">
                        <span class="text-xs font-medium text-gray-500"><?php echo e($default_language_name); ?></span>
            ...
            <div class="flex items-center justify-center md:justify-items-start mb-4 md:mb-0">
                ...
                <div>
                    <a href="<?php echo e(url('/')); ?>" class="h-full">
                        <img src="<?php echo e(src(settings('footer')->logo)); ?>" alt="<?php echo e(settings('general')->title); ?>" class="py-2.5 max-h-10">
                    </a>
                </div>
        ...
        <div class="text-center mt-10">
            ...
            <div class="flex space-x-4 justify-center rtl:space-x-reverse">
                ...
                <a href="<?php echo e(url('help/contact')); ?>" class="text-xs font-medium uppercase text-gray-600 hover:underline rtl:ml-4"><?php echo e(__('messages.t_contact_us')); ?></a>


                <?php if (settings('footer')->privacy): ?>
                    <a href="<?php echo e(url('page', settings('footer')->privacy->slug)); ?>" class="text-xs font-medium uppercase text-gray-600 hover:underline"><?php echo e(__('messages.t_privacy_policy')); ?></a>
                <?php endif;?>


                <?php if (settings('footer')->terms): ?>
                    <a href="<?php echo e(url('page', settings('footer')->terms->slug)); ?>" class="text-xs font-medium uppercase text-gray-600 hover:underline rtl:!ml-0"><?php echo e(__('messages.t_terms_of_service')); ?></a>
                <?php endif;?>


                <?php if (settings('blog')->enable_blog): ?>
                    <a href="<?php echo e(url('blog')); ?>" class="text-xs font-medium uppercase text-gray-600 hover:underline rtl:!ml-0"><?php echo e(__('messages.t_blog')); ?></a>
                <?php endif;?>
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/includes/footer.blade.php ENDPATH**/?>