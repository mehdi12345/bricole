	                    ...
	                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="reviews-<?php echo e($review->id); ?>">
	                        ...
	                        <td class="ltr:pl-4 rtl:pr-4">
	                            <a href="<?php echo e(url('profile', $review->user->username)); ?>" target="_blank" class="flex items-center">
	                                <div class="w-8 h-8">
	                                    <img class="w-full h-full rounded object-cover" src="<?php echo e(src($review->user->avatar)); ?>" alt="<?php echo e($review->user->username); ?>" />
	                                </div>
	                                <div class="ltr:pl-4 rtl:pr-4">
                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div id="table-options-dropdown-<?php echo e($review->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">
                                        ...
                                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this')); ?>') ? $wire.delete('<?php echo e($review->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($review->id); ?>')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/reviews/reviews.blade.php ENDPATH**/?>