    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200" wire:key="section_images">
        ...
        <div class="bg-gray-50 px-8 py-4 rounded-t-md">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_images')); ?></h3>
                    <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_get_noticed_by_right_buyers_images')); ?></p>
                </div>
                <?php if (!$video_link): ?>
...
<?php endif;?>
            ...
            <div wire:ignore>
                <span class="mb-2 text-xs font-medium tracking-wide flex items-center text-gray-700"><?php echo e(__('messages.t_upload_gig_images')); ?></span>
    ...
    <?php if ($video_link): ?>
        <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200" wire:key="section_video">
            ...
            <div class="bg-gray-50 px-8 py-4 rounded-t-md">
                <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                    <div class="ml-4 mt-4">
                        <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_video')); ?></h3>
                        <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_capture_buyer_attention_with_video')); ?></p>
                    </div>
                    <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
    ...
    <?php if (settings('publish')->is_documents_enabled): ?>
        <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200" wire:key="section_documents">
            ...
            <div class="bg-gray-50 px-8 py-4 rounded-t-md">
                <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                    <div class="ml-4 mt-4">
                        <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_documents')); ?></h3>
                        <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_show_some_of_best_work_doc_pdfs_only')); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-span-12">
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <i class="mdi mdi-youtube <?php echo e($errors->first('video_link') ? 'text-red-400' : 'text-gray-400'); ?>"></i>
                        </div>
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/create/steps/gallery.blade.php ENDPATH**/?>