	...
	<header>
			...
			<div>
				<table style="  font-size: 75%;table-layout: fixed;border-collapse: separate;border-spacing: 2px; width: 100%;">
					...
					<th>
					<img src="<?php echo e($imageGig); ?>" alt="logo" style="width: 128px; height: 128px; border-radius: 10%;"/>
					</th>
					<th>
					<p><?php echo e($title); ?></p>
						<p><?php echo e($ville); ?></p>
						<p><?php echo e($area); ?></p>
					</th>
				</table>
			</div>
		...
		<div>
			...
			<table style="  clear: both;content: '';display: table;width: 36%;">
				...
				<tr>
					...
					<td style="  border-color: #ddd; border-width: 1px;padding: 0.5em;position: relative;text-align: left; border-radius: 0.25em;border-style: solid; width: 60%;border-width: 1px; padding: 0.5em; position: relative; text-align: left;  border-radius: 0.25em; border-style: solid;"><span ><?php echo e($createAt); ?></span></td>
				</tr>
				<!-- <tr>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/pdf.blade.php ENDPATH**/ ?>