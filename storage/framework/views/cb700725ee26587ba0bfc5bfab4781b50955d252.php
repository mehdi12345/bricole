                        ...
                        <li class="relative px-4 group" x-data="{ open: false }">
                            ...
                            <template x-if="open">
                                <ul x-transition:enter="transition-all ease-in-out duration-300"
                                    ...
                                    <?php $__currentLoopData = $link['childs'];
...
$loop = $__env->getLastLoop();?>
                ...
                <li class="relative px-4 flex items-center group !mt-8">
                    <div class="text-xs font-normal text-gray-400">You are running bricole version <?php echo e(config('global.version')); ?></div>
                </li>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/includes/sidebar.blade.php ENDPATH**/?>