<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_edit_area')); ?></h2>
            </div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_area_name')).'','placeholder' => ''.e(__('messages.t_entre_area_name')).'','model' => 'name','icon' => 'format-title']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_area_slug')).'','placeholder' => ''.e(__('messages.t_entre_area_slug')).'','model' => 'slug','icon' => 'link-variant']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala0274761f86638d78e36787c771a294b67c238db)): ?>
<?php $component = $__componentOriginala0274761f86638d78e36787c771a294b67c238db; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_parent_ville')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_choix_printer_ville')),'model' => 'parent_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories),'isDefer' => true,'isAssociative' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'componentId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->id),'value' => 'id','text' => 'name']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/areas/options/edit.blade.php ENDPATH**/ ?>