...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all());?>
<?php endif;?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_site_logo')), 'model' => 'logo', 'accept' => 'image/jpg,image/jpeg,image/png,image/svg+xml']);?>
<?php echo $__env->renderComponent(); ?>
<?php endif;?>
...
</div>    <?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/settings/general.blade.php ENDPATH**/?>