...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all());?>
<?php endif;?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_content')), 'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_enter_page_content')), 'model' => 'content', 'old' => '' . $page->content . '']);?>
<?php echo $__env->renderComponent(); ?>
<?php endif;?>
...
</div>    <?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/pages/options/edit.blade.php ENDPATH**/?>