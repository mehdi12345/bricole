                        ...
                        <div class="inline-block w-full py-2 align-middle overflow-y-auto">
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr wire:key="seller-reviews-id-<?php echo e($review->id); ?>">
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div class="z-0">
                                                        <button data-dropdown-toggle="seller-gigs-options-<?php echo e($review->id); ?>" data-dropdown-placement="left-start" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0 z-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                                    ...
                                                    <div id="seller-gigs-options-<?php echo e($review->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">

                                                    
                                                    <?php if( $review->status != "active"): ?>
                                                        <div class="py-1" role="none">
                                                                <button x-on:click="confirm('Are you sure you want to accepter this gig?') ? $wire.accepter('<?php echo e($review->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($review->id); ?>')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
                                                                    
                                                                    <div wire:loading wire:target="accepter('<?php echo e($review->id); ?>')">
                                                                    ...
                                                                    <div wire:loading.remove wire:target="accepter('<?php echo e($review->id); ?>')">
                                                        ...
                                                        <!-- 
                                                                        ...
                                                                        <div class="py-1" role="none">
                                                                            <li>
                                                                                <a href="<?php echo e(url('account/orders/requirements')); ?>"  class="flex items-center px-4 py-2 hover:bg-gray-100 rounded-b">
                                                        ...
                                                        <div class="py-1" role="none">
                                                        <a href="<?php echo e(url('account/orders/requirements',$review->id)); ?>" class="flex items-center px-4 py-2 hover:bg-gray-100 rounded-b">
                                                                    ...
                                                                    <span class="text-xs font-medium"><?php echo e(__('messages.t_send_requirements')); ?></span>

                                                         </a>
                                                        </div>

                                                        
                                                            <?php if($review->id_requirment > 0): ?>
                                                                <div class="py-1" role="none">
                                                                    <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_remove_from_favorite_list')); ?>') ? $wire.dawland('<?php echo e($review->id_requirment); ?>','<?php echo e($review->id); ?>') : ''"   class="flex items-center px-4 py-2 hover:bg-gray-100">
                                                        ...
                                                        <div class="py-1" role="none">
                                                                <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_gig')); ?>') ? $wire.delete('<?php echo e($review->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($review->id); ?>')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/demandes/demandes.blade.php ENDPATH**/ ?>