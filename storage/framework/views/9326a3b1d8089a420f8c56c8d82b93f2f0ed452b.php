        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_refunds')); ?></h1>
                            ...
                            <table class="w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr class="divide-x divide-gray-50">
                                        <th scope="col" class="px-10 py-3 ltr:text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('messages.t_item')); ?></th>
    ...
    $__empty_1 = false;?>
	                                        <tr wire:key="seller-refunds-id-<?php echo e($refund->uid); ?>">
	                                            ...
	                                            <td class="whitespace-nowrap py-4 ltr:pl-10 rtl:pr-10 ltr:pr-3 rtl:pl-3 text-sm font-medium text-gray-900 sm:ltr:pl-10 sm:rtl:pr-10">
	                                                <div class="flex items-center">
	                                                    <div class="h-10 w-10 flex-shrink-0">
	                                                        <img class="h-10 w-10 rounded-full" src="<?php echo e(src($refund->item->gig->thumbnail)); ?>" alt="<?php echo e($refund->item->gig->title); ?>">
	                                                    </div>
	                                                    <div class="ltr:ml-4 rtl:mr-4">
	                                                        <a href="<?php echo e(url('service', $refund->item->gig->slug)); ?>" target="_blank" class="font-medium text-gray-900 pb-1 hover:text-indigo-600 block"><?php echo e($refund->item->gig->title); ?></a>
	                                            ...
	                                            <td class="whitespace-nowrap py-4 ltr:pl-10 rtl:pr-10 ltr:pr-3 rtl:pl-3 text-sm font-medium text-gray-900 sm:ltr:pl-10 sm:rtl:pr-10">
	                                                <div class="flex items-center">
	                                                    <div class="h-10 w-10 flex-shrink-0">
	                                                        <img class="h-10 w-10 rounded-full" src="<?php echo e(src($refund->buyer->avatar)); ?>" alt="<?php echo e($refund->buyer->username); ?>">
	                                                    </div>
	                                                    <div class="ltr:ml-4 rtl:mr-4">
	                                                        <a href="<?php echo e(url('profile', $refund->buyer->username)); ?>" target="_blank" class="font-medium text-gray-900 pb-1 hover:text-indigo-600 block text-sm"><?php echo e($refund->buyer->username); ?></a>
	                                                        <div class="font-normal text-gray-500 text-xs">
	                                                            <?php if ($refund->buyer->fullname): ?>
	                                                                <?php echo e($refund->buyer->username); ?>
...
case ('pending'): ?>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div>
                                                        <a href="<?php echo e(url('seller/refunds/details', $refund->uid)); ?>" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0" aria-expanded="true" aria-haspopup="true">
...
<?php $__env->stopPush();?><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/seller/refunds/refunds.blade.php ENDPATH**/?>