        ...
        <table class="w-full whitespace-nowrap">
            <thead class="bg-gray-200">
                <tr tabindex="0"
                    ...
                    <th class="font-bold text-[10px] text-slate-500 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_email_address')); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_ip_address')); ?></th>
            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="lists-<?php echo e($list->id); ?>">
                        ...
                        <td class="ltr:pl-4 rtl:pr-4">
                            <a href="https://ip-api.com/#<?php echo e($list->ip_address); ?>" target="_blank" class="font-medium text-xs text-indigo-600 hover:text-indigo-700"><?php echo e($list->ip_address); ?></a>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="relative inline-block text-left">
                                <div>
                                    <button data-dropdown-toggle="table-options-dropdown-<?php echo e($list->id); ?>" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                ...
                                <div id="table-options-dropdown-<?php echo e($list->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">

                                        
                                        <?php if($list->status === 'pending'): ?>
                                            <button wire:click="resend('<?php echo e($list->id); ?>')" wire:loading.attr="disabled" wire:target="resend('<?php echo e($list->id); ?>')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
                                        ...
                                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this')); ?>') ? $wire.delete('<?php echo e($list->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($list->id); ?>')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/newsletter/newsletter.blade.php ENDPATH**/ ?>