...
} elseif ($_instance->childHasBeenRendered('h5QUY8l')) {
    $componentId = $_instance->getRenderedChildComponentId('h5QUY8l');
    $componentTag = $_instance->getRenderedChildComponentTagName('h5QUY8l');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('h5QUY8l');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('h5QUY8l', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('6biLpnh')) {
    $componentId = $_instance->getRenderedChildComponentId('6biLpnh');
    $componentTag = $_instance->getRenderedChildComponentTagName('6biLpnh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6biLpnh');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('6biLpnh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
