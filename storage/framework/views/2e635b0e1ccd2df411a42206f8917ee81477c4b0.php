                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        ...
                        <div class="mb-14 lg:flex lg:items-center lg:justify-between">
                            <div class="flex-1 min-w-0">
                                <h2 class="text-base leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_delivered_work')); ?></h2>
                                <p class="mt-1 text-sm text-gray-500"><?php echo e(__('messages.t_download_received_files_from_seller')); ?></p>
                            </div>
                            <?php if (!$item->is_finished && $item->status === 'delivered'): ?>
                                <div class="mt-5 flex lg:mt-0 lg:ltr:ml-4 lg:rtl:mr-4">
                                    ...
                                    <?php if (!$item->refund): ?>
                                        <span class="block">
                                            <a href="<?php echo e(url('account/refunds/request', $item->uid)); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-xs font-bold tracking-wide text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        <?php if (!$item->is_finished): ?>
                            <div class="flex items-center mb-8 text-blue-500">
                                ...
                                <span class="text-xs font-medium tracking-wide ltr:ml-2 rtl:mr-2"><?php echo e(__('messages.t_order_item_will_mark_done_after_1_week', ['date' => format_date($item->delivered_at, 'F j, Y')])); ?></span>
                            </div>
                        <?php endif;?>
                                        ...
                                        <div class="bg-gray-50 px-8 py-4 rounded-t-md">
                                            <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_conversation_with_seller')); ?></h3>
                                                    <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_communicate_with_seller_about_changes')); ?></p>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="w-full">
                                                <ul role="list" class="py-6 px-8">
                                                    ...
                                                    <?php $__currentLoopData = $item->conversation;
                                    ...
                                    <section class="mb-6">
                                        <div class="rounded-lg bg-white overflow-hidden border border-gray-200">
                                            <div class="bg-gray-50 px-8 py-4 rounded-t-md">
                                                <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                                    <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                                        <h3 class="text-base leading-6 font-black tracking-widest text-gray-600"><?php echo e(__('messages.t_download_files')); ?></h3>
                                                        <p class="text-xs font-normal text-gray-400"><?php echo e(__('messages.t_always_scan_files_before_open_delivered_work')); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="px-8 py-5">
...
</main><?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/account/orders/options/files.blade.php ENDPATH**/?>