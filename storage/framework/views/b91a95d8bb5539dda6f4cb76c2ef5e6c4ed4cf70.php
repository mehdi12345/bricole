...
} elseif ($_instance->childHasBeenRendered('l2643729533-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2643729533-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2643729533-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2643729533-0');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $review->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2643729533-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
