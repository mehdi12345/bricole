...
} elseif ($_instance->childHasBeenRendered('B2X1gE5')) {
    $componentId = $_instance->getRenderedChildComponentId('B2X1gE5');
    $componentTag = $_instance->getRenderedChildComponentTagName('B2X1gE5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('B2X1gE5');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('B2X1gE5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    ...
                    <?php else: ?>
                        <div class="relative overflow-hidden h-[600px]">
                            ...
                            <div style="background-image: url(<?php echo e(asset('img/home/4.jpg')); ?>);" class="absolute inset-x-0 bottom-0 top-0  bg-opacity-80 p-6 backdrop-filter backdrop-blur sm:flex sm:items-center sm:justify-between lg:inset-y-0 lg:inset-x-auto lg:w-full lg:flex-col lg:items-center">
...
} elseif ($_instance->childHasBeenRendered('YotVIqe')) {
    $componentId = $_instance->getRenderedChildComponentId('YotVIqe');
    $componentTag = $_instance->getRenderedChildComponentTagName('YotVIqe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YotVIqe');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('YotVIqe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\bricole-latest\bricole\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>