<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_create_area')); ?></h2>
            </div>
...
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/admin/areas/options/create.blade.php ENDPATH**/ ?>