...
<?php endif;?>
                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_write_a_review')); ?></h2>
                            <p class="mt-1 text-sm text-gray-500"><?php echo e(__('messages.t_give_ur_opinion_about_this_item')); ?></p>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('l3873988391-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3873988391-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3873988391-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3873988391-0');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l3873988391-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush();?>
<?php /**PATH C:\xampp\htdocs\main\bricole\resources\views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/?>