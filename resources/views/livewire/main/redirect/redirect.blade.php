    ...
    <div class="flex flex-row gap-10 place-content-center justify-center">
        <div class="w-full lg:basis-3/4">
            ...
            <div class="relative w-full lg:max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div class="max-w-lg mx-auto rounded-md border shadow-sm overflow-hidden lg:max-w-none lg:flex">
                    <div class="flex-1 bg-white px-6 py-8 lg:p-12">
                        <div class="text-2xl font-extrabold text-gray-900 sm:text-3xl flex items-center">
                        ...
                        <div class="mt-8">
                            <div class="flex items-center">
                                <h4 class="flex-shrink-0 ltr:pr-4 rtl:pl-4 bg-white text-sm tracking-wider font-semibold uppercase text-gray-500">
                  ...
                  <div class="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                    <div class="mt-6">
                        <div class="rounded-md shadow">
                            <a href="{{ $link }}" class="flex items-center justify-center px-12 py-3 border border-transparent text-base font-medium rounded-sm text-white bg-gray-800 hover:bg-gray-900">
                                {{ __('messages.t_proceed') }}
                            </a>
                        </div>
                    </div>
                    <div class="mt-4 text-sm">
                        <a href="{{ url('/') }}" class="font-medium text-gray-500 underline">
