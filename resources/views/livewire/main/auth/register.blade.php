        ...
        <div class="px-4 py-8 sm:px-10">
            ...
            <div class="">
                <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <x-forms.text-input
                            :label="__('messages.t_phon_number')"
                            :placeholder="__('messages.t_enter_phon_number')"
                            model="phon"
                            type="text"
                            icon="call" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <x-forms.text-input
                            label="CIN code or passport code"
                            placeholder="Enter CIN code or passport code"
                            model="cin_or_passport"
                            type="text"
                            icon="address" />
                    </div>
