    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-100 border border-gray-50 rounded-xl px-4 py-4 lg:px-12 lg:py-12">
        ...
        <div class="w-full mb-0 md:mb-12">
            ...
            <div class="md:flex items-center justify-between mb-0 md:mb-6">
                ...
                <div class="hidden items-center md:!grid">
                    ...
                    <span class="text-black !font-['Lato'] text-2xl tracking-wide font-black">{{$gig->price}} DH</span>
                </div>
        ...
        <div class="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div class="max-w-2xl mx-auto mt-6 md:mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                    {{-- Contact seller --}}
                    <a href="{{ url('payment', $gig->id) }}" target="_blank" class="w-full bg-indigo-50 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-[13px] font-medium text-indigo-700 hover:bg-indigo-100 focus:outline-none">payment platform</a>
                                                    ...
                                                    <a href="{{ url('profile', $review->user->username) }}" target="_blank" class="text-sm font-bold text-gray-900 flex items-center group-hover:text-indigo-600">
                                                        ...
                                                        @if ($review->user->country)
                                                            <div class="ltr:ml-2 rtl:mr-2">
                                                                <img src="{{ asset('img/flags/'. strtolower($review->user->country?->code) .'.svg') }}" alt="{{ $review->user->country?->name }}" class="h-3 -mt-px rounded-sm">
                                                            </div>
                                                        @endif
