            ...
            <div class="col-span-3">
                ...
                @if (settings('footer')->is_language_switcher)
                    <button @click="languages = !languages" class="inline-flex items-center px-2.5 py-2 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mt-10">
                        <img src="{{ asset('img/flags/rounded/'. strtolower($default_country_code) .'.svg') }}" alt="" class="w-4 h-4 ltr:mr-3 rtl:ml-3">
                        ...
                        @foreach (supported_languages() as $lang)
                            <div @if ($default_language_code !== $lang->language_code) wire:click="setLocale('{{ $lang->language_code }}')" @endif class="py-2 px-4 rounded-sm inline-flex items-center cursor-pointer justify-between {{ $default_language_code === $lang->language_code ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-50' }} focus:outline-none">
                                <div class="inline-flex items-center">
                                    <img src="{{ asset('img/flags/rounded/' . $lang->country_code . '.svg') }}" alt="{{ $lang->name }}" class="w-5 ltr:mr-3 rtl:ml-3">
