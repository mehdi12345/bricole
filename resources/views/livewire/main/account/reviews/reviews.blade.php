                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900">{{ __('messages.t_reviews') }}</h2>
                            <p class="mt-1 text-sm text-gray-500">{{ __('messages.t_account_reviews_subtitle') }}</p>
                        </div>
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody class="w-full">
                                    ...
                                    @foreach ($reviews as $review)
                                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="reviews-{{ $review->id }}">
                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="{{ url('service', $review->gig->slug) }}" target="_blank" class="flex items-center">
                                                    ...
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        <p class="font-medium text-xs truncate max-w-[200px] block overflow-hidden">{{ $review->gig->title }}</p>
                                            ...
                                            <td class="text-center">
                                                <span class="text-[11px] font-normal text-gray-400">{{ format_date($review->created_at, 'ago') }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div>
                                                        <button data-dropdown-toggle="table-options-dropdown-{{ $review->id }}" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                                    ...
                                                    <div id="table-options-dropdown-{{ $review->id }}" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                                        <div class="py-1" role="none">

                                                            {{-- Preview review --}}
                                                            <a href="{{ url('account/reviews/preview/' . $review->uid) }}" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                                            ...
                                                            {{-- Edit review --}}
                                                            <a href="{{ url('account/reviews/edit/' . $review->uid) }}" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="ltr:mr-3 rtl:ml-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                                                <span class="text-xs font-medium">{{ __('messages.t_edit_review') }}</span>
                                                            </a>
                    
                                                            {{-- Delete --}}
                                                            <button x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_delete_this_review') }}') ? $wire.delete('{{ $review->id }}') : ''" wire:loading.attr="disabled" wire:target="delete('{{ $review->id }}')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
