            ...
            <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x rtl:divide-x-reverse">
                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="xl:grid xl:grid-cols-3 py-10 px-8">
                        <div class="xl:col-span-2 xl:ltr:pr-8 xl:rtl:pl-8 xl:ltr:border-r xl:rtl:border-l xl:border-gray-200">
                            <div>
                                <div>
                                    <div class="md:flex md:items-center md:justify-between md:space-x-4 md:rtl:space-x-reverse xl:border-b xl:pb-6">
                                        <div>
                                            <h1 class="text-base font-bold text-gray-900">{{ __('messages.t_refund_details') }}</h1>
                                            <div class="mt-2 text-xs font-medium tracking-wide text-blue-500 hover:text-indigo-600 flex items-center">
                                    ...
                                    <aside class="mt-8 xl:hidden">
                                        <div class="space-y-5">
                                            ...
                                            {{-- Amount --}}
                                            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor"> <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"/> <path fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd"/></svg>
                                                <span class="text-gray-700 text-sm font-black tracking-wide font-['Lato']">@money($refund->item->total_value, settings('currency')->code, true)</span>
                                            </div>
                                            ...
                                            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                ...
                                                <span class="text-gray-700 text-sm font-medium">{{ __('messages.t_created_on_date', ['date' => format_date($refund->created_at, 'F j, Y')]) }}</span>
                                            </div>
                            ...
                            <section class="mt-8 xl:mt-10">
                                <div>
                                    <div class="divide-y divide-gray-200">
                                        <div class="pb-4">
                                            <h2 class="text-base font-extrabold tracking-wider text-gray-900">
                                                ...
                                                <div class="mt-6">
                                                    <div class="flex space-x-3 rtl:space-x-reverse">
                                                        <div class="flex-shrink-0">
                                                            <div class="relative">
                                                                <img class="h-10 w-10 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white object-cover" src="{{ src(auth()->user()->avatar) }}" alt="{{ auth()->user()->username }}">
                                                            </div>
                                                        </div>
                                                        <div class="min-w-0 flex-1">
                                                            <div>
                                                            ...
                                                            <div class="mt-6 flex items-center justify-end space-x-4 rtl:space-x-reverse">
                                                                <button x-on:click="confirm('{{ __('messages.t_are_u_sure_close_refund_dispute') }}') ? $wire.close : ''" wire:loading.attr="disabled" wire:target="close" type="button" class="inline-flex justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 h-12 items-center">
