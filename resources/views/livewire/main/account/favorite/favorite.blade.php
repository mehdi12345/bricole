                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900">{{ __('messages.t_favorite_list') }}</h2>
                            <p class="mt-1 text-sm text-gray-500">{{ __('messages.t_favorite_list_subtitle') }}</p>
                        </div>
                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="{{ url('service', $l->gig->slug) }}" target="_blank" class="flex items-center">
                                                    ...
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        ...
                                                        <p class="text-[11px] leading-3 text-gray-600 pt-2">@money($l->gig->price, settings('currency')->code, true)</p>
                                                    </div>
                                                </a>
                                            </td>
