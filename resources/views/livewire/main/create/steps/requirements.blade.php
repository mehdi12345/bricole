<div class="w-full" x-data="window.lMgwOjCpqGgzsVV" x-init="initialize">
    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
        ...
        {{-- Section title --}}
        <div class="bg-gray-50 px-8 py-4 {{ count($requirements) === 0 ? 'rounded-md' : 'rounded-t-md' }}">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_requirements') }}</h3>
                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_create_gig_requirements_subtitle') }}</p>
                </div>
