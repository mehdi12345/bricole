<div class="max-w-5xl mx-auto">
        ...
        <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">                    
                    ...
                    <a href="{{ url('blog') }}" class="ltr:ml-4 rtl:mr-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ __('messages.t_blog') }}</a>
                </div>
            </li>
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ltr:ml-4 rtl:mr-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">
                        {{ $article->title }}
                    </span>
                </div>
            </li>
    ...
    {{-- Article content --}}
    <div class="relative py-16 mt-6 bg-white overflow-hidden rounded-lg shadow">
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="text-lg max-w-prose mx-auto">
                ...
                {{-- Title --}}
                <h1 class="mb-6">
                    <span class="block text-xs text-center text-indigo-600 font-semibold tracking-wide uppercase">{{ __('messages.t_x_min_read', ['x' => $article->reading_time]) }}</span>
                    <span class="mt-2 block text-xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-2xl">{{ $article->title }}</span>
                </h1>
                ...
                {{-- Share --}}
                <span class="text-center font-medium text-gray-800 text-sm mb-4 mt-24 flex items-center justify-center">{{ __('messages.t_share') }}</span>
    ...
    @if (settings('blog')->enable_comments)
        <div class="bg-white shadow rounded-lg sm:overflow-hidden mt-10">
            <div class="divide-y divide-gray-200">
                <div class="px-4 py-5 sm:px-6">
                    <h2 class="text-base font-bold tracking-wide text-gray-900">{{ __('messages.t_comments') }}</h2>
                </div>
                        ...
                        @foreach ($comments as $cm)
                            <li>
                                <div class="flex space-x-3">
                                    ...
                                    <div>
                                        <div class="text-sm">
                                            <span class="font-bold text-gray-900">{{ $cm->name }}</span>
                                        </div>
            ...
            {{-- Add comment --}}
            <div class="border-t-2 border-gray-100 bg-gray-50 px-4 py-6 sm:px-6 mt-10">
                <div class="flex">
                        ...
                        <form wire:submit.prevent="addComment">
                            ...
                            <div class="mt-6 flex items-center justify-between">
                                ...
                                <button 
                                    ...
                                    class="text-xs font-medium flex justify-center bg-indigo-500 hover:bg-indigo-600 text-white py-4 px-8 rounded tracking-wide focus:outline-none focus:shadow-outline cursor-pointer"
