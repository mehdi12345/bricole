    ...
    <div class="mb-12 bg-white shadow shadow-gray-100 rounded-md border border-gray-200 max-w-xl mx-auto">
        ...
        <div class="bg-gray-50 px-8 py-4 rounded-t-md border-b-2 border-gray-100">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                <h3 class="text-base leading-6 font-black text-gray-900 mb-2">{{ __('messages.t_contact_us') }}</h3>
                <p class="text-sm font-medium text-gray-500">{{ __('messages.t_contact_us_subtitle') }}</p>
                </div>
            </div>
        </div>
