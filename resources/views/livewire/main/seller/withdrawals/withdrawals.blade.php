        ...
        <div class="rounded-md bg-green-100 p-4 mb-6">
            <div class="flex">
                ...
                <div class="ltr:ml-3 rtl:mr-3">
                    <h3 class="text-sm font-medium text-green-800">{{ __('messages.t_congratulations') }}</h3>
        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_withdrawals') }}</h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                    ...
                    {{-- Withdrawal settings --}}
                    <span class="hidden sm:block ltr:ml-3 rtl:pr-3">
                        <a href="{{ url('seller/withdrawals/settings') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-purple-500">
