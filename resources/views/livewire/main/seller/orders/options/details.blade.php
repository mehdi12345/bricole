        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_order_details') }}</h1>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ltr:ml-4 rtl:mr-4">
                                ...
                                <div class="mt-1 text-xs space-x-2 rtl:space-x-reverse">
                                    ...
                                    {{-- View gig --}}
                                    <a href="{{ url('service', $order->gig->slug) }}" target="_blank" class="text-indigo-600 font-medium">
                                    ...
                                    {{-- Edit gig --}}
                                    <a href="{{ url('seller/gigs/edit', $order->gig->uid) }}" target="_blank" class="text-indigo-600 font-medium">
            ...
            <div class="w-full rounded-b-md">
                <dl>
                    ...
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-10">
                        <dt class="text-sm font-medium text-black">{{ __('messages.t_date_placed') }}</dt>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-10">
                        <dt class="text-sm font-medium text-black">{{ __('messages.t_status') }}</dt>
                    ...
                    @if ($order->has('upgrades'))
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-10 rounded-b-md">
                            <dt class="text-sm font-medium text-black">{{ __('messages.t_upgrades') }}</dt>
