        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_edit_project') }}</h1>
                        ...
                        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                            ...
                            <div class="col-span-12">
                                <div class="flex justify-between items-center">
                                    <label class="mb-2 text-xs font-medium tracking-wide flex items-center text-gray-700">{{ __('messages.t_project_images') }}</label>
                                    <div @click="update_gallery = !update_gallery" class="text-xs text-indigo-600 font-medium hover:underline cursor-pointer">
