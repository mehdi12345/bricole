        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_my_projects') }}</h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                    ...
                    {{-- Create new project --}}
                    <span class="hidden sm:block ltr:ml-3 rtl:mr-3">
                        <a href="{{ url('seller/portfolio/create') }}" class="inline-flex items-center px-4 py-2 border border-purple-500 rounded-sm shadow-sm text-[13px] font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-50 focus:ring-purple-700">
                            ...
                            <table class="w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr class="divide-x divide-gray-50">
                                        <th scope="col" class="px-10 py-3 ltr:text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('messages.t_project_id') }}</th>
                                        <th scope="col" class="px-10 py-3 ltr:text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('messages.t_project') }}</th>
                                        ...
                                        <tr wire:key="seller-projects-id-{{ $project->uid }}">
                                            ...
                                            <td class="whitespace-nowrap py-4 ltr:pl-10 rtl:pr-10 ltr:pr-3 rtl:pl-3 text-sm font-medium text-gray-900 sm:ltr:pl-10 sm:rtl:pr-10">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ltr:ml-4 rtl:mr-4">
                                                        <a href="{{ url('projects', $project->slug) }}" target="_blank" class="font-medium text-gray-900 pb-1 hover:text-indigo-600 block">{{ $project->title }}</a>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div class="z-0">
                                                        <button data-dropdown-toggle="seller-projects-options-{{ $project->uid }}" data-dropdown-placement="left-start" type="button" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0 z-0" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                                    ...
                                                    <div id="seller-projects-options-{{ $project->uid }}" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                                        <div class="py-1" role="none">

                                                            {{-- Edit --}}
                                                            <a href="{{ url('seller/portfolio/edit', $project->uid) }}" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                                            ...
                                                            {{-- Delete --}}
                                                            <button x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_delete_project') }}') ? $wire.delete('{{ $project->uid }}') : ''" wire:loading.attr="disabled" wire:target="delete('{{ $project->uid }}')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
