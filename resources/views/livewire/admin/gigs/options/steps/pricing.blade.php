    ...
    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
        ...
        <div class="col-span-12 mb-10">
            <div class="md:flex md:items-center md:justify-between ltr:border-l-8 border-indigo-600 ltr:pl-4 rtl:border-r-8 rtl:pr-4">
                ...
                <div class="mt-4 flex md:mt-0 ltr:md:ml-4 rtl:md:mr-4">
                    ...
                    {{-- Back to gigs --}}
                    <a href="{{ admin_url('gigs') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-xs font-medium text-gray-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div class="col-span-12 xl:col-span-5">
            @foreach ($upgrades as $key => $upgrade)
                <div class="bg-white rounded-lg shadow-sm border border-gray-10 px-8 py-6 mb-6" id="scroll-to-upgrade-id-{{ $key }}" wire:key="edit-gig-pricing-upgrade-id-{{ $key }}">
                            ...
                            <div class="w-full inline-block relative">
                                <div class="relative">
                                    <input wire:model.defer="add_upgrade.title"
                                        class="indent-6 block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal {{ $errors->first('add_upgrade.title') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500' }}"
                    ...
                    <div class="col-span-12" wire:key="{{ uid() }}">
                        <div class="flex-grow relative">
                            <input wire:model.defer="add_upgrade.price"
                                class="block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal {{ $errors->first('add_upgrade.price') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500' }}"
