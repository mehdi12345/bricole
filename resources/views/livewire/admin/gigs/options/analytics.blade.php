                ...
                <div class="intro-x">
                    <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden ring-gray-100 ring-1">
                            <img alt="{{ $city->country_name }}" src="{{ asset('img/flags', strtolower("$city->country_code.svg")) }}">
                        </div>
                        <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
...
@push('scripts')
    ...
    {{-- jVectorMap Plugin --}}
    <script src="{{ url('js/plugins/jvectormap/jquery-jvectormap-2.0.5.min.js') }}"></script>
    <script src="{{ url('js/plugins/jvectormap/jquery-jvectormap-world-mill.js') }}"></script>
