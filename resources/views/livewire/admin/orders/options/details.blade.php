                                                ...
                                                <div class="ltr:text-left rtl:text-right sm:!text-center">
                                                    ...
                                                    @else
                                                        @switch($item->status)
                                                            ...
                                                            {{-- finished --}}
                                                            @case('finished')
                                                                <p data-tooltip-target="orders-{{ $order->uid }}-item-{{ $item->id }}-status-finished" class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                    finished
                                                                </p>
                                                                <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-status-finished" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                    {{ format_date($item->finished_at, 'F j, Y h:i A') }}
                                                                </div>
                                                                @break
