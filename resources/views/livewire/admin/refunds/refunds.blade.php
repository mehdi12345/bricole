        ...
        <table class="w-full whitespace-nowrap">
            ...
            <tbody class="w-full">
                ...
                @foreach ($refunds as $r)
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100" wire:key="refunds-{{ $r->id }}">
                        ...
                        {{-- Date --}}
                        <td class="text-center">
                            <span class="text-[11px] font-normal text-gray-400">{{ format_date($r->created_at, 'ago') }}</span>
                        </td>
