            ...
            <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pb-4 ltr:text-left rtl:text-right overflow-hidden shadow transform transition-all sm:align-middle sm:p-6 mb-8 w-full">
                ...
                @if ($refund->status === 'rejected_by_seller' && $refund->request_admin_intervention)
                    <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                        ...
                        {{-- Give refund --}}
                        <button x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_approve_this_refund') }}') ? $wire.accept : ''" wire:loading.attr="disabled" wire:target="accept" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none sm:col-start-2 sm:text-sm">
                ...
                <div class="border-t border-gray-200">
                    <dl>
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-[13px] font-medium text-indigo-700 hover:text-indigo-600 sm:mt-0 sm:col-span-2">
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-[13px] font-[Lato] font-extrabold text-gray-900 sm:mt-0 sm:col-span-2">
