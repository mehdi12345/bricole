<nav class="w-full">
    ...
    <div class="border-b border-gray-100">
        ...
        class="{{ Request::is('account/demande') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-3 py-3 flex items-center text-sm font-medium">
            <svg xmlns="http://www.w3.org/2000/svg"
