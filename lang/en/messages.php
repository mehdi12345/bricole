...
return [
    "t_my_demande" => "my requests",
    "t_create_account" => "Create account",
    "t_sign_in" => "Sign in",
    "t_email_address" => "E-mail address",
    "t_ville" => "citys",
    "t_area" => "Area",
    "t_this_ville_has_some_gigs_please_edit_it" => "There are some gigs in this city , please try to edit it instead",
    "t_edit_city" => "Edit city",
    "t_city_name" => "City name",
    "t_enter_city_name" => "Enter city name",
    "t_city_slug" => "City slug",
    "t_enter_city_slug" => "Enter city slug",
    "t_demande" => "demande",
    "t_subvilles" => "Areas",
    "t_parent_ville" => "PARENT VILLE",
    "t_this_subville_has_some_gigs_please_edit_it" => "This Area has some gigs please edit it",
    "t_create_area" => "Create Area",
    "t_area_name" => "Area name",
    "t_entre_area_name" => "Enter Area name",
    "t_area_slug" => "Area slug",
    "t_entre_area_slug" => "Enter Area slug",
    "t_printer_ville" => "Parent ville",
    "t_choix_printer_ville" => "Choose parent ville",
    "t_edit_area" => "Edit Area",
    ...
    "t_seller_dashboard" => "Worker dashboard",
    "t_become_a_seller" => "Become a worker",
    "t_login" => "Login",
    ...
    "t_price" => "Price",
    "t_delivery_time" => "Working time",
    "t_choose_delivery_time" => "Choose working time",
    ...
    "t_refunded" => "Refunded",
    "t_actions" => "Actions",
    "t_contact_seller" => "Contact worker",
    ...
    "t_u_have_send_reqs_asap_to_seller" => "You have to send the required information to worker to start processing your order as soon as possible",
    ...
    "t_submit_ur_info_now_seller_start_order" => "Submit your info now so that the worker may begin the order",
    ...
    "t_submitted_files_preview_subtitle" => "Information you will submit to worker will be visible below, you can change them later",
    "t_submit" => "Submit",
    ...
    "t_user_already_submitted_requirements" => "It looks like your already submitted the required information to worker. Please try to re-submit them again",
    "t_required_info_submitted_success" => "The required information have been sent to the worker to start processing your order",
    "t_u_didnt_submit_any_info_yet_requirements" => "It looks like you did not send any required information to re-submit them",
    "t_resubmit_requirements_success_msg" => "You can now send new required sinformation to worker",
    ...
    "t_go_shopping" => "Go home",
    "t_get_started_now" => "Get started now",
    "t_become_a_seller_subtitle" => "Become a top worker on our platform and start making profits online",
    ...
    "t_boost_ur_productivity_subtitle" => "The key to your success on our platform is the brand you build for yourself through your reputation with us. We gathered some tips and resources to help you become a leading worker on our platform",
    ...
    "t_become_a_successful_seller" => "Become a successful worker",
    ...
    "t_register_subtitle" => "ماذا تريد ان تفعل؟ يمكنك العثور عليها في المستقل. وظف أفضل العاملين لحسابهم الخاص لأي وظيفة ، عبر الإنترنت ، يستخدم ملايين الأشخاص العاملين لحسابهم الخاص لتحويل أفكارهم إلى حقيقة. ابحث عن محترفين يمكنك الوثوق بهم من خلال تصفح عينات من أعمالهم السابقة وقراءة مراجعات ملفاتهم الشخصية.",
    ...
    "t_become_a_seller_subtitle_card" => "Start your online business with us today as a professional worker and earn money.",
    "t_sort_by" => "Sort by",
    ...
    "t_conversation_with_seller" => "Conversation with worker",
    "t_communicate_with_seller_about_changes" => "Communicate with worker about changes or requests",
    "t_download_received_files_from_seller" => "Download received files from worker",
    "t_are_sure_completed_work_buyer" => "Please confirm that you have received the work. You won\'t be able to ask the worker for any changes after that",
    ...
    "t_enter_maximum_sales_for_seller" => "Enter maximum sales for worker",
    "t_enter_minimum_sales_for_seller" => "Enter minimum sales for worker",
    ...
    "t_request_refund_subtitle" => "We recommend you always to contact the worker before request a refund",
    ...
    "t_declined_by_seller" => "Declined by worker",
    "t_declined_by_admin" => "Declined by :app_name",
    "t_approved_by_seller" => "Approved by worker",
    ...
    "t_send_requirements_subtitle" => "Send the required info to worker to process your order",
    ...
    "t_ur_gig_title_has_been_demande" => "Your gig :title has been successfully demande",
    ...
    "t_u_became_a_seller" => "Welcome! You have became a worker",
    ...
    "t_seller_has_canceled_ur_order" => ":Worker has canceled your order",
    "t_seller_has_started_ur_order" => ":Worker has started your order",
    "t_seller_has_delivered_ur_order" => ":Worker has delivered your order",
    "t_seller_sent_u_msg_about_ur_refund_request" => ":Worker has sent you a message about your refund request",
    "t_seller_has_accepted_ur_refund" => ":Worker has accepted your refund",
    "t_u_have_declined_this_refund" => "You have declined this refund",
    "t_seller_has_declined_ur_refund" => ":Worker has declined your refund",
    ...
    "t_notification_admin_refund_dispute" => "A user has raised a dispute about a refund, because worker has decided to decline it, please click the button below to see refund details",
    ...
    "t_subject_buyer_order_canceled" => "Your order item has been canceled by worker",
    ...
    "t_subject_buyer_refund_declined" => "Your refund request has declined by worker",
    "t_hello_username" => "Hello :username",
    "t_view_delivered_work" => "View delivered work",
    "t_notification_ur_order_item_has_delivered" => "Your order item has been successfully delivered by worker, click the button below to see delivered work",
    "t_notification_u_have_new_msg_refund_from_seller" => "You have received this message from worker about your refund request, click the button below to see refund details",
    ...
    "t_notification_buyer_order_placed" => "Thank you! your order has been successfully placed do not forget to submit the required info for workers to start your order items",
    ...
    "t_subject_seller_u_became_seller" => "Welcome to worker dashboard",
    ...
    "t_notification_seller_line_1_u_became_seller" => "You have became a worker now, you can share your works now and start receiving orders",
    ...
    "t_best_sellers" => "Best workers",
    "t_show_best_sellers" => "Show best workers",
    "t_primary_button_text" => "Primary button text",
    "t_hero_section_badge_link" => "Badge link",
    "t_top_sellers" => "Top workers",
    "t_hire_our_best_sellers" => "Hire our best experts workers",
    ...
    "t_notification_admin_pending_offline_payment" => "A customer used offline payment in his order, Once you receive the payment mark the invoice as paid, so worker can process his order",
    ...
    "t_ur_payment_has_been_received_offline" => "Your payment has been received, you can now submit the required files to worker",
    "t_paystack" => "Paystack",
    ...
    "t_phon_number" => "number phone",
    "t_enter_phon_number" => "Enter number phone",
