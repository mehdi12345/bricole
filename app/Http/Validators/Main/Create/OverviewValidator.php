...
class OverviewValidator
{
    ...
    public static function all($request)
    {
        try {
            ...
            $rules = [
                ...
                'subville' => 'required|exists:subvilles,id',
            ...
            $messages = [
                ...
                'ville.required' => __('messages.t_validator_required'),
                'ville.exists' => __('messages.t_validator_exists'),
                'subville.required' => __('messages.t_validator_required'),
                'subville.exists' => __('messages.t_validator_exists'),
     ...
     * @return void
     */
    public static function faq($request)
    {
        try {
