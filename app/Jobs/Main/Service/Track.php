...
class Track implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            // Bot producer name
            $bot_producer_name        = $is_bot && is_array($bot) ? $bot['producer']['name'] : null ;

            // Get bot producer url
            $bot_producer_url         = $is_bot && is_array($bot) ? $bot['producer']['url'] : null ;
            ...
            $browser_language         = $detect_browser_lang->best();
